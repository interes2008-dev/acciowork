...
export const Route = createFileRoute("/it/guide/$guide")({
  loader: ({ params }) => {
  ...
  head: ({ loaderData }) => {
    ...
    const url = `https://acciowork.pro/it/guide/${slug}`;
        ...
        },
        {
          ...
          children: JSON.stringify({
            ...
            itemListElement: [
              ...
              { "@type": "ListItem", position: 2, name: "Guide", item: "https://acciowork.pro/it/guide" },
