...
export const Route = createFileRoute("/de/compare/$competitor")({
  loader: ({ params }) => {
  ...
  head: ({ loaderData }) => {
    ...
    const url = `https://acciowork.pro/de/compare/${slug}`;
      ...
      scripts: [
        ...
        },
        {
          ...
          children: JSON.stringify({
            ...
            "@type": "BreadcrumbList",
            itemListElement: [
              { "@type": "ListItem", position: 1, name: "Accio Work", item: "https://acciowork.pro/de/" },
              { "@type": "ListItem", position: 2, name: "Comparisons", item: "https://acciowork.pro/de/compare" },
