      ...
      scripts: [
        {
          ...
          children: JSON.stringify({
            ...
            isPartOf: { "@type": "Blog", name: "Blog Accio Work", url: `${SITE}${PREFIX}` },
        ...
        },
        {
          ...
          children: JSON.stringify({
            ...
            "@type": "BreadcrumbList",
            itemListElement: [
              { "@type": "ListItem", position: 1, name: "Accio Work", item: `${SITE}/fr` },
              { "@type": "ListItem", position: 2, name: "Blog Accio Work", item: `${SITE}${PREFIX}` },
