...
export const Route = createFileRoute("/fr/compare/$competitor")({
  loader: ({ params }) => {
  ...
  head: ({ loaderData }) => {
    ...
    const url = `https://acciowork.pro/fr/compare/${slug}`;
        ...
        },
        {
          ...
          children: JSON.stringify({
            ...
            itemListElement: [
              ...
              { "@type": "ListItem", position: 2, name: "Comparisons", item: "https://acciowork.pro/fr/compare" },
