...
export const Route = createFileRoute("/ru/guide/$guide")({
  loader: ({ params }) => {
  ...
  head: ({ loaderData }) => {
    ...
    const url = `https://acciowork.pro/ru/guide/${slug}`;
        ...
        },
        {
          ...
          children: JSON.stringify({
            ...
            itemListElement: [
              ...
              { "@type": "ListItem", position: 2, name: "Guide", item: "https://acciowork.pro/ru/guide" },
