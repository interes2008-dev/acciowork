...
export const Route = createFileRoute("/ar/blog/$slug")({
  loader: async ({ params }) => {
    const bundle = await getArticleBundle({ data: { lang: "ar", slug: params.slug } });
  ...
  head: ({ loaderData }) => {
    ...
    if (!a) {
      return {
        meta: [{ title: "مدوّنة Accio Work" }, { name: "robots", content: "noindex, follow" }],
        links: [],
        scripts: [],
      };
    }
    const url = `https://acciowork.pro/ar/blog/${a.slug}`;
    ...
    return {
      meta: [
        { title: a.title.length <= 45 ? `${a.title} | مدوّنة Accio Work` : a.title },
          ...
          children: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                ...
                position: 2,
                name: "مدوّنة Accio Work",
                item: `https://acciowork.pro/ar/blog`,
              },
  ...
  notFoundComponent: () => <div className="p-10 text-center">المقال غير موجود</div>,
});
