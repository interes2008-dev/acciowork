...
export const Route = createFileRoute("/blog/$slug")({
  loader: async ({ params }) => {
    const bundle = await getArticleBundle({ data: { lang: "en", slug: params.slug } });
  ...
  head: ({ loaderData }) => {
    ...
    const url = `https://acciowork.pro/blog/${a.slug}`;
      ...
      scripts: [
        {
          ...
          children: JSON.stringify({
            ...
            isPartOf: { "@type": "Blog", name: "Accio Work Blog", url: `https://acciowork.pro/blog` },
        ...
        },
        {
          ...
          children: JSON.stringify({
            ...
            "@type": "BreadcrumbList",
            itemListElement: [
              { "@type": "ListItem", position: 1, name: "Accio Work", item: `https://acciowork.pro` || "https://acciowork.pro" },
              { "@type": "ListItem", position: 2, name: "Accio Work Blog", item: `https://acciowork.pro/blog` },
...
function ArticleEn() {
  ...
  return (
    <I18nProvider>
      <BlogArticle lang="en" article={article} related={related} />
    </I18nProvider>
  );
}
