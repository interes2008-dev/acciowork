...
export const Route = createFileRoute("/it/templates")({
  head: () => {
    const c = tplChrome[LANG];
    const url = "https://acciowork.pro/it/templates";
    const alternates: Array<{ rel: string; hrefLang: string; href: string }> = LANGS.map((l) => ({ rel: "alternate", hrefLang: l, href: `https://acciowork.pro${l === "en" ? "" : "/" + l}/templates` }));
