...
export const Route = createFileRoute("/ru/compare/$competitor")({
  loader: ({ params }) => {
  ...
  head: ({ loaderData }) => {
    ...
    const url = `https://acciowork.pro/ru/compare/${slug}`;
        ...
        },
        {
          ...
          children: JSON.stringify({
            ...
            itemListElement: [
              ...
              { "@type": "ListItem", position: 2, name: "Comparisons", item: "https://acciowork.pro/ru/compare" },
