...
export const Route = createFileRoute("/hi/blog/$slug")({
  ...
  head: ({ loaderData }) => {
    ...
    if (!a) {
      return { meta: [{ title: "Accio Work ब्लॉग" }, { name: "robots", content: "noindex" }] };
    }
    ...
    const pageTitle = a.title.length <= 45 ? `${a.title} | Accio Work ब्लॉग` : a.title;
    const cover = a.cover_url ? `${SITE}${a.cover_url}` : `${SITE}/og/og-hi.png`;
      ...
      scripts: [
        {
          ...
          children: JSON.stringify({
            ...
            isPartOf: { "@type": "Blog", name: "Accio Work ब्लॉग", url: `${SITE}${PREFIX}` },
        ...
        },
        {
          ...
          children: JSON.stringify({
            ...
            "@type": "BreadcrumbList",
            itemListElement: [
              { "@type": "ListItem", position: 1, name: "Accio Work", item: `${SITE}/hi` },
              { "@type": "ListItem", position: 2, name: "Accio Work ब्लॉग", item: `${SITE}${PREFIX}` },
