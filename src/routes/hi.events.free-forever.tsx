...
const URL_SELF = "https://acciowork.pro/hi/events/free-forever";

export const Route = createFileRoute("/hi/events/free-forever")({
  head: () => ({
    meta: [
    ...
    links: [
      ...
      { rel: "alternate", hreflang: "ar", href: "https://acciowork.pro/ar/events/free-forever" },
      {
        rel: "alternate",
        hreflang: "x-default",
