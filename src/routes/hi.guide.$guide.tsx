...
export const Route = createFileRoute("/hi/guide/$guide")({
  loader: ({ params }) => {
  ...
  head: ({ loaderData }) => {
    ...
    const url = `https://acciowork.pro/hi/guide/${slug}`;
        ...
        },
        {
          ...
          children: JSON.stringify({
            ...
            itemListElement: [
              ...
              { "@type": "ListItem", position: 2, name: "Guide", item: "https://acciowork.pro/hi/guide" },
