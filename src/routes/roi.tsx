...
export const Route = createFileRoute("/roi")({
  ...
  head: ({ loaderData }) => {
    ...
    const url = "https://acciowork.pro/roi";
    ...
    return {
      ...
      scripts: [
        { type: "application/ld+json", children: JSON.stringify({ "@context":"https://schema.org","@type":"BreadcrumbList", itemListElement:[{"@type":"ListItem",position:1,name:"Accio Work",item:"https://acciowork.pro/"},{"@type":"ListItem",position:2,name:c.kicker,item:url}] }) },
      ],
    };
  },
