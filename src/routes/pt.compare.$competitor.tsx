...
export const Route = createFileRoute("/pt/compare/$competitor")({
  loader: ({ params }) => {
  ...
  head: ({ loaderData }) => {
    ...
    const url = `https://acciowork.pro/pt/compare/${slug}`;
        ...
        },
        {
          ...
          children: JSON.stringify({
            ...
            itemListElement: [
              ...
              { "@type": "ListItem", position: 2, name: "Comparisons", item: "https://acciowork.pro/pt/compare" },
