...
export const Route = createFileRoute("/it/blog/$slug")({
  loader: async ({ params }) => {
    const bundle = await getArticleBundle({ data: { lang: "it", slug: params.slug } });
  ...
  head: ({ loaderData }) => {
    ...
    const url = `https://acciowork.pro/it/blog/${a.slug}`;
      ...
      scripts: [
        {
          ...
          children: JSON.stringify({
            ...
            isPartOf: { "@type": "Blog", name: "Blog Accio Work", url: `https://acciowork.pro/it/blog` },
        ...
        },
        {
          ...
          children: JSON.stringify({
            ...
            "@type": "BreadcrumbList",
            itemListElement: [
              { "@type": "ListItem", position: 1, name: "Accio Work", item: `https://acciowork.pro/it` || "https://acciowork.pro" },
              { "@type": "ListItem", position: 2, name: "Blog Accio Work", item: `https://acciowork.pro/it/blog` },
...
function ArticleIt() {
  ...
  return (
    <I18nProvider>
      <BlogArticle lang="it" article={article} related={related} />
    </I18nProvider>
  );
}
