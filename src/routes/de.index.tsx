...
export const Route = createFileRoute("/de/")({
  ...
  head: () => ({
    meta: [
      ...
      {
        property: "og:title",
        content: "Accio Work | KI-Plattform für Sourcing und Business-Automatisierung",
      },
      {
      ...
      { property: "og:image:type", content: "image/png" },
      {
        ...
        content: "Accio Work, KI-Arbeitsbereich für Sourcing, Analyse und Automatisierung",
      },
      ...
      { name: "twitter:title", content: "Accio Work | KI-Plattform für Sourcing" },
      {
        ...
        content:
          "KI-Arbeitsbereich: Sourcing, Wettbewerbsanalyse, Content-Erstellung und Automatisierung.",
      },
