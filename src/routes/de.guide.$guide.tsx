...
export const Route = createFileRoute("/de/guide/$guide")({
  loader: ({ params }) => {
  ...
  head: ({ loaderData }) => {
    ...
    const url = `https://acciowork.pro/de/guide/${slug}`;
        ...
        },
        {
          ...
          children: JSON.stringify({
            ...
            itemListElement: [
              ...
              { "@type": "ListItem", position: 2, name: "Guide", item: "https://acciowork.pro/de/guide" },
