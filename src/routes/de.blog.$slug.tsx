...
export const Route = createFileRoute("/de/blog/$slug")({
  ...
  head: ({ loaderData }) => {
    ...
    if (!a) {
      return { meta: [{ title: "Accio Work Blog" }, { name: "robots", content: "noindex" }] };
    }
    ...
    const pageTitle = a.title.length <= 45 ? `${a.title} | Accio Work Blog` : a.title;
    const cover = a.cover_url ? `${SITE}${a.cover_url}` : `${SITE}/og/og-de.png`;
      ...
      scripts: [
        {
          ...
          children: JSON.stringify({
            ...
            isPartOf: { "@type": "Blog", name: "Accio Work Blog", url: `${SITE}${PREFIX}` },
        ...
        },
        {
          ...
          children: JSON.stringify({
            ...
            "@type": "BreadcrumbList",
            itemListElement: [
              { "@type": "ListItem", position: 1, name: "Accio Work", item: `${SITE}/de` },
              { "@type": "ListItem", position: 2, name: "Accio Work Blog", item: `${SITE}${PREFIX}` },
