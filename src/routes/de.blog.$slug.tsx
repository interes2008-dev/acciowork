...
export const Route = createFileRoute("/de/blog/$slug")({
  loader: async ({ params }) => {
    const bundle = await getArticleBundle({ data: { lang: "de", slug: params.slug } });
  ...
  head: ({ loaderData }) => {
    ...
    if (!a) {
      return {
        meta: [{ title: "Accio Work Blog" }, { name: "robots", content: "noindex, follow" }],
        links: [],
        scripts: [],
      };
    }
    const url = `https://acciowork.pro/de/blog/${a.slug}`;
    ...
    return {
      meta: [
        { title: a.title.length <= 45 ? `${a.title} | Accio Work Blog` : a.title },
      ...
      scripts: [
        {
          ...
          children: JSON.stringify({
            ...
            isPartOf: { "@type": "Blog", name: "Accio Work Blog", url: `https://acciowork.pro/de/blog` },
        ...
        },
        {
          ...
          children: JSON.stringify({
            ...
            "@type": "BreadcrumbList",
            itemListElement: [
              { "@type": "ListItem", position: 1, name: "Accio Work", item: `https://acciowork.pro/de` || "https://acciowork.pro" },
              { "@type": "ListItem", position: 2, name: "Accio Work Blog", item: `https://acciowork.pro/de/blog` },
...
function ArticleDe() {
  ...
  return (
    <I18nProvider>
      <BlogArticle lang="de" article={article} related={related} />
    </I18nProvider>
  );
}
