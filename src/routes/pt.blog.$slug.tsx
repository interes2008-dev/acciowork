...
export const Route = createFileRoute("/pt/blog/$slug")({
  loader: async ({ params }) => {
    const bundle = await getArticleBundle({ data: { lang: "pt", slug: params.slug } });
  ...
  head: ({ loaderData }) => {
    ...
    const url = `https://acciowork.pro/pt/blog/${a.slug}`;
      ...
      scripts: [
        {
          ...
          children: JSON.stringify({
            ...
            isPartOf: { "@type": "Blog", name: "Blog Accio Work", url: `https://acciowork.pro/pt/blog` },
        ...
        },
        {
          ...
          children: JSON.stringify({
            ...
            "@type": "BreadcrumbList",
            itemListElement: [
              { "@type": "ListItem", position: 1, name: "Accio Work", item: `https://acciowork.pro/pt` || "https://acciowork.pro" },
              { "@type": "ListItem", position: 2, name: "Blog Accio Work", item: `https://acciowork.pro/pt/blog` },
...
function ArticlePt() {
  ...
  return (
    <I18nProvider>
      <BlogArticle lang="pt" article={article} related={related} />
    </I18nProvider>
  );
}
