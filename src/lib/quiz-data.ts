...
export type QzLang = "en" | "ru" | "de" | "it" | "es" | "zh" | "pt" | "hi" | "fr" | "ar";
type L = Record<QzLang, string>;
export interface QzOption {
  label: L;
  score: number;
}
...
export const qzChrome: Record<QzLang, QzChrome> = {
  ar: {
    kicker: "فحص من دقيقتين",
    h1: "هل Accio Work مناسب لك؟",
    intro:
      "خمسة أسئلة سريعة. تحصل على قراءة صادقة عمّا إذا كان هذا الوكيل يناسب عملك، بما في ذلك متى لا يناسبه.",
    next: "التالي",
    back: "السابق",
    seeResult: "أظهر نتيجتي",
    retake: "ابدأ من جديد",
    of: "من",
    question: "سؤال",
    resultKicker: "نتيجتك",
    ...
    disclaimer: "هذا دليل سريع، لا حكم نهائي. تجربتك الخاصة هي الاختبار الحقيقي.",
    metaTitle: "هل Accio Work مناسب لك؟ | فحص ملاءمة في دقيقتين",
    metaDesc:
      "أجب عن خمسة أسئلة سريعة واحصل على قراءة صادقة عمّا إذا كان Accio Work، وكيل Alibaba الذكي، يناسب عملك، بما في ذلك متى لا يناسبه.",
  },
  en: {
    kicker: "2 minute check",
    h1: "Is Accio Work right for you?",
    intro:
      "Five quick questions. You get an honest read on whether this agent fits your business, including when it does not.",
    next: "Next",
    back: "Back",
    ...
    metaDesc:
      "Answer five quick questions and get an honest read on whether Accio Work, Alibaba's AI agent, fits your business, including when it does not.",
  },
  ru: {
    kicker: "Проверка за 2 минуты",
    h1: "Подходит ли вам Accio Work?",
    intro:
      "Пять коротких вопросов. Получите честный ответ, подходит ли этот агент вашему делу, включая случаи, когда нет.",
    next: "Дальше",
    back: "Назад",
    ...
    metaDesc:
      "Ответьте на пять коротких вопросов и получите честный ответ, подходит ли Accio Work, AI-агент Alibaba, вашему делу, включая случаи, когда нет.",
  },
  de: {
    kicker: "2 Minuten Check",
    h1: "Passt Accio Work zu dir?",
    intro:
      "Fünf kurze Fragen. Du bekommst eine ehrliche Einschätzung, ob dieser Agent zu deinem Geschäft passt, auch wann nicht.",
    next: "Weiter",
    back: "Zurück",
    ...
    disclaimer:
      "Das ist ein schneller Wegweiser, kein Urteil. Der echte Test ist dein eigener Versuch.",
    metaTitle: "Passt Accio Work zu dir? | 2 Minuten Check",
    metaDesc:
      "Beantworte fünf kurze Fragen und erhalte eine ehrliche Einschätzung, ob Accio Work, Alibabas KI-Agent, zu deinem Geschäft passt, auch wann nicht.",
  },
  it: {
    kicker: "Verifica in 2 minuti",
    h1: "Accio Work fa per te?",
    intro:
      "Cinque domande veloci. Ottieni una lettura onesta se questo agente si adatta alla tua attività, anche quando no.",
    next: "Avanti",
    back: "Indietro",
    ...
    metaDesc:
      "Rispondi a cinque domande veloci e ottieni una lettura onesta se Accio Work, l'agente AI di Alibaba, si adatta alla tua attività, anche quando no.",
  },
  es: {
    kicker: "Chequeo de 2 minutos",
    h1: "¿Accio Work es para ti?",
    intro:
      "Cinco preguntas rápidas. Obtienes una lectura honesta de si este agente encaja con tu negocio, incluso cuando no.",
    next: "Siguiente",
    back: "Atrás",
    ...
    metaDesc:
      "Responde cinco preguntas rápidas y obtén una lectura honesta de si Accio Work, el agente de IA de Alibaba, encaja con tu negocio, incluso cuando no.",
  },
  zh: {
    kicker: "2 分钟自测",
    h1: "Accio Work 适合你吗？",
    ...
    metaDesc:
      "回答五个快速问题，得到一个诚实的判断，看阿里的 AI 智能体 Accio Work 是否适合你的生意，也包括不适合的情况。",
  },
  pt: {
    kicker: "Teste de 2 minutos",
    h1: "O Accio Work é para você?",
    intro:
      "Cinco perguntas rápidas. Você recebe uma leitura honesta se este agente combina com seu negócio, inclusive quando não.",
    next: "Próxima",
    back: "Voltar",
    ...
    metaDesc:
      "Responda cinco perguntas rápidas e receba uma leitura honesta se o Accio Work, agente de IA da Alibaba, combina com seu negócio, inclusive quando não.",
  },
  hi: {
    kicker: "2 मिनट की जांच",
    h1: "क्या Accio Work आपके लिए है?",
    intro:
      "पांच त्वरित सवाल। आपको ईमानदार जवाब मिलेगा कि यह एजेंट आपके कारोबार में फिट है या नहीं, यह भी कि कब नहीं।",
    next: "आगे",
    back: "पीछे",
    ...
    metaDesc:
      "पांच त्वरित सवालों के जवाब दें और ईमानदार जवाब पाएं कि Alibaba का AI एजेंट Accio Work आपके कारोबार में फिट है या नहीं, यह भी कि कब नहीं।",
  },
  fr: {
    kicker: "Test de 2 minutes",
    h1: "Accio Work est-il fait pour vous ?",
    intro:
      "Cinq questions rapides. Vous obtenez un avis honnête sur l'adéquation de cet agent à votre activité, y compris quand ce n'est pas le cas.",
    next: "Suivant",
    back: "Retour",
    ...
    metaDesc:
      "Répondez à cinq questions rapides et obtenez un avis honnête sur l'adéquation d'Accio Work, l'agent IA d'Alibaba, à votre activité, y compris quand ce n'est",
  },
};
...
export const qzQuestions: QzQuestion[] = [
  ...
  },
  {
    q: {
      ...
      ar: "كم من أسبوعك يذهب لعمل متكرّر كالتوريد والبحث والقوائم والإدارة؟",
    },
    options: [
      {
        label: {
  ...
  },
  {
    q: {
      ...
      ar: "ما شعورك تجاه وكيل ذكاء اصطناعي ينفّذ مهاماً حقيقية لا مجرّد محادثة؟",
    },
    options: [
      {
        label: {
...
export const qzResults: { strong: QzResult; partial: QzResult; weak: QzResult } = {
  strong: {
    title: {
      ...
      ar: "يبدو Accio Work ملائماً بقوة",
    },
    body: {
      ...
      ar: "أنت تبيع عبر الحدود وتوفّر منتجاتك بالطريقة التي بُني Accio Work لأجلها. ما يؤتمته من توريد وتفاوض وبحث ينطبق مباشرة على أسبوعك. ابدأ مجاناً وضعه على مهمة حقيقية واحدة.",
    },
    cta: true,
  },
  partial: {
    ...
    body: {
      ...
      ar: "بعض ما تفعله يتوافق مع Accio Work وبعضه لا. قوّته في التوريد عبر الحدود ومنظومة Alibaba، لذا تعتمد الفائدة على مقدار ما تمارسه من ذلك. تجربة مجانية على مهمة واحدة ستخبرك بسرعة.",
    },
    cta: true,
  },
  weak: {
    title: {
      ...
      ar: "الأرجح أن Accio Work ليس أفضل أداة لك",
    },
    body: {
      ...
      ar: "يتألّق Accio Work مع بائعي التجارة عبر الحدود المرتبطين بمنظومة Alibaba. من إجاباتك، ليس هذا تكوينك فعلاً، لذا الأرجح أن وكيلاً عامّاً أو أداة مبنية لقناتك ستخدمك أكثر. نفضّل أن نصارحك على أن نبالغ في البيع.",
    },
    cta: false,
  },
};
