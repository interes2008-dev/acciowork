...
export type ScLang = "en" | "ru" | "de" | "it" | "es" | "zh" | "pt" | "hi" | "fr" | "ar";
type L = Record<ScLang, string>;
export interface ScOption {
  s: number;
  l: L;
}
export interface ScCriterion {
  q: L;
  opts: ScOption[];
}
export interface ScVerdict {
  ...
  title: L;
  body: L;
  tips: Record<ScLang, string[]>;
}
export interface ScChrome {
  kicker: string;
  h1: string;
  intro: string;
  scoreLabel: string;
...
export const scChrome: Record<ScLang, ScChrome> = {
  ar: {
    kicker: "أداة تفاعلية مجانية",
    h1: "بطاقة تقييم موثوقية المورّد",
    intro:
      "قيّم مورّداً عبر ستة عوامل تتنبّأ بالمتاعب، واحصل على درجة موثوقية صادقة مع ما ينبغي فحصه قبل تحويل المال. تُدخل ما تعرفه، وهذه تتولّى الحساب، ولا تُختلق بيانات مورّد.",
    scoreLabel: "درجة الموثوقية",
    recommendations: "ما العمل تالياً",
    share: "شارك النتيجة",
    copied: "نُسخ الرابط",
    resultKicker: "درجة موثوقية المورّد",
    cta: "دقّق المورّدين مع Accio Work",
    ctaShort: "دقّق المورّدين",
    ctaNote: "باقة مجانية، بلا بطاقة",
    accioLabel: "دع الذكاء الاصطناعي يتحقّق نيابةً عنك",
    ctaLine:
      "يفحص Accio Work المورّدين والمنتجات مقابل بيانات Alibaba الحيّة ويتحقّق منها بشكل متقاطع، لتلتقط مخاطر قد تفوتها قائمة تدقيق وحدها.",
    note: "هذه أداة تقييم ذاتي، لا ضمان. اطلب دائماً عيّنة واستخدم دفعاً آمناً قبل طلب كبير.",
    metaTitle: "بطاقة تقييم موثوقية المورّد (أداة مجانية) | Accio Work",
    metaDesc:
      "بطاقة تفاعلية مجانية لتقييم مورّد Alibaba عبر ستة عوامل خطر والحصول على درجة موثوقية مع الخطوات التالية. بعدّة لغات.",
  },
  en: {
    kicker: "Free interactive tool",
    h1: "Supplier reliability scorecard",
    intro:
      "Rate a supplier across six factors that predict trouble, and get an honest reliability score with what to check before you wire money. You enter what you know, this does the math, no supplier data is invented.",
    ...
    ctaShort: "Vet suppliers",
    ctaNote: "Free plan, no card required",
    accioLabel: "Let AI cross-check for you",
    ctaLine:
      "Accio Work checks suppliers and products against live Alibaba data and cross-verifies them, so you catch risks a checklist alone can miss.",
    ...
    metaDesc:
      "Free interactive scorecard to rate an Alibaba supplier across six risk factors and get a reliability score with next steps. Nine languages.",
  },
  ru: {
    kicker: "Бесплатный интерактивный инструмент",
    h1: "Скоринг надёжности поставщика",
    intro:
      "Оцените поставщика по шести факторам, которые предсказывают проблемы, и получите честный балл надёжности плюс что проверить до перевода денег. Вы вводите то, что знаете, расчёт делает инструмент, данные о поставщиках не выдумываются.",
    ...
    ctaLine:
      "Accio Work сверяет поставщиков и товары с живыми данными Alibaba и перепроверяет их, так вы ловите риски, которые чек-лист один пропустит.",
    ...
    metaDesc:
      "Бесплатный интерактивный скоринг: оцените поставщика Alibaba по шести факторам риска и получите балл надёжности с шагами. 9 языков.",
  },
  de: {
    kicker: "Kostenloses interaktives Tool",
    h1: "Scorecard für Lieferantenzuverlässigkeit",
    intro:
      "Bewerte einen Lieferanten anhand von sechs Faktoren, die Ärger vorhersagen, und erhalte einen ehrlichen Zuverlässigkeitswert plus was du vor der Überweisung prüfen solltest. Du gibst ein, was du weißt, die Rechnung macht das Tool, keine Lieferantendaten werden erfunden.",
    ...
    ctaLine:
      "Accio Work gleicht Lieferanten und Produkte mit Live-Alibaba-Daten ab und verifiziert sie, so erkennst du Risiken, die eine Checkliste allein übersieht.",
    ...
    metaDesc:
      "Kostenlose interaktive Scorecard: bewerte einen Alibaba-Lieferanten anhand sechs Risikofaktoren und erhalte einen Zuverlässigkeitswert mit Schritten.",
  },
  it: {
    kicker: "Strumento interattivo gratuito",
    h1: "Scorecard di affidabilità del fornitore",
    intro:
      "Valuta un fornitore su sei fattori che predicono i problemi e ottieni un punteggio di affidabilità onesto con cosa controllare prima di inviare denaro. Inserisci ciò che sai, il calcolo lo fa lo strumento, nessun dato del fornitore viene inventato.",
    ...
    ctaShort: "Valuta i fornitori",
    ctaNote: "Piano gratuito, nessuna carta",
    accioLabel: "Fai verificare all'AI",
    ctaLine:
      "Accio Work confronta fornitori e prodotti con i dati Alibaba in tempo reale e li verifica, così cogli rischi che una checklist da sola può perdere.",
    ...
    metaDesc:
      "Scorecard interattiva gratuita: valuta un fornitore Alibaba su sei fattori di rischio e ottieni un punteggio di affidabilità con i passi successivi.",
  },
  es: {
    kicker: "Herramienta interactiva gratis",
    h1: "Scorecard de fiabilidad del proveedor",
    intro:
      "Evalúa a un proveedor en seis factores que predicen problemas y obtén una puntuación de fiabilidad honesta con qué revisar antes de enviar dinero. Tú ingresas lo que sabes, la herramienta calcula, no se inventan datos del proveedor.",
    ...
    ctaShort: "Evalúa proveedores",
    ctaNote: "Plan gratuito, sin tarjeta",
    accioLabel: "Deja que la IA verifique",
    ctaLine:
      "Accio Work coteja proveedores y productos con datos de Alibaba en vivo y los verifica, así detectas riesgos que una lista sola puede pasar por alto.",
    ...
    metaDesc:
      "Scorecard interactiva gratis: evalúa a un proveedor de Alibaba en seis factores de riesgo y obtén una puntuación de fiabilidad con pasos.",
  },
  zh: {
    kicker: "免费互动工具",
    h1: "供应商可靠度评分卡",
    intro:
      "从六个能预示麻烦的维度给供应商打分，得到一个诚实的可靠度分值，以及打款前该核查什么。你填你知道的，计算由工具完成，不虚构任何供应商数据。",
    scoreLabel: "可靠度分值",
    ...
    ctaLine:
      "Accio Work 依据阿里实时数据核对供应商与产品并交叉验证，帮你发现清单单独可能漏掉的风险。",
  ...
  pt: {
    ...
    intro:
      "Avalie um fornecedor em seis fatores que preveem problemas e obtenha uma pontuação de confiabilidade honesta com o que checar antes de enviar dinheiro. Você insere o que sabe, a ferramenta calcula, nenhum dado do fornecedor é inventado.",
    ...
    ctaShort: "Avalie fornecedores",
    ctaNote: "Plano gratuito, sem cartão",
    accioLabel: "Deixe a IA verificar",
    ctaLine:
      "O Accio Work compara fornecedores e produtos com dados ao vivo da Alibaba e os verifica, assim você pega riscos que uma checklist sozinha pode perder.",
    ...
    metaDesc:
      "Scorecard interativa grátis: avalie um fornecedor da Alibaba em seis fatores de risco e obtenha uma pontuação de confiabilidade com passos.",
  },
  hi: {
    kicker: "मुफ्त इंटरैक्टिव टूल",
    h1: "सप्लायर विश्वसनीयता स्कोरकार्ड",
    intro:
      "छह कारकों पर सप्लायर को आंकें जो दिक्कत की भविष्यवाणी करते हैं, और पैसे भेजने से पहले क्या जाँचना है के साथ एक ईमानदार विश्वसनीयता स्कोर पाएं। आप जो जानते हैं वह भरते हैं, गणना टूल करता है, कोई सप्लायर डेटा नहीं गढ़ा जाता।",
    ...
    ctaShort: "सप्लायर परखें",
    ctaNote: "मुफ्त प्लान, कार्ड की जरूरत नहीं",
    accioLabel: "AI से क्रॉस-चेक कराएं",
    ctaLine:
      "Accio Work सप्लायर और उत्पादों को अलीबाबा के लाइव डेटा से मिलाकर सत्यापित करता है, ताकि आप वे जोखिम पकड़ें जो अकेली चेकलिस्ट छोड़ सकती है।",
    ...
    metaDesc:
      "मुफ्त इंटरैक्टिव स्कोरकार्ड: अलीबाबा सप्लायर को छह जोखिम कारकों पर आंकें और अगले कदमों के साथ विश्वसनीयता स्कोर पाएं। नौ भाषाएं।",
  },
  fr: {
    kicker: "Outil interactif gratuit",
    h1: "Scorecard de fiabilité du fournisseur",
    intro:
      "Évaluez un fournisseur sur six facteurs qui annoncent des ennuis et obtenez un score de fiabilité honnête avec quoi vérifier avant de virer de l'argent. Vous saisissez ce que vous savez, l'outil calcule, aucune donnée fournisseur n'est inventée.",
    ...
    ctaLine:
      "Accio Work compare fournisseurs et produits aux données Alibaba en direct et les vérifie, vous repérez ainsi des risques qu'une checklist seule peut manquer.",
    ...
    metaDesc:
      "Scorecard interactive gratuite : évaluez un fournisseur Alibaba sur six facteurs de risque et obtenez un score de fiabilité avec des étapes.",
  },
};
...
export const scVerdicts = {
  strong: {
    ...
    body: {
      ...
      ar: "إشارات قوية في كل المحاور. تحقّق من الطلب النهائي بالطريقة نفسها التي تحقّقت بها من العيّنة.",
    },
    tips: {
      en: [
      ...
      zh: ["生产前把条款写清楚", "仍使用 Trade Assurance 或担保", "尾款前验批"],
      pt: [
      ...
      ar: [
        "ثبّت الشروط كتابةً قبل الإنتاج",
        "استخدم ضمان التجارة أو الضمان على أي حال",
        "افحص الدفعة قبل الدفع النهائي",
      ],
    },
  },
  caution: {
    ...
    body: {
      ...
      ar: "بعض الثغرات قد تؤذيك. أغلقها قبل أن تلتزم بكمية.",
    },
    tips: {
      en: [
      ...
      ar: ["اطلب عيّنة مدفوعة أولاً", "اطلب شهادات خاصة بسوقك", "ابدأ بطلب تجريبي صغير"],
    },
  },
  risk: {
    min: 0,
    ...
    body: {
      ...
      ar: "إشارات حمراء كثيرة على إرسال المال بعد. تعامل معه كعميل محتمل للتأهيل، لا كمورّد للدفع.",
    },
    tips: {
      en: [
      ...
      zh: ["切勿电汇全额预付", "独立核实该公司", "与另外两三家供应商比较"],
      pt: [
      ...
      ar: [
        "لا تدفع المبلغ كاملاً مقدّماً بالتحويل",
        "تحقّق من الشركة بشكل مستقلّ",
        "قارن مع مورّدين اثنين أو ثلاثة آخرين",
      ],
    },
  },
