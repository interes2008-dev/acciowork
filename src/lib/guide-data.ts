...
export type GdLang = "en" | "ru" | "de" | "it" | "es" | "zh" | "pt" | "hi" | "fr" | "ar";
export interface GdStep {
  title: string;
  desc: string;
}
export interface GdFaq {
  q: string;
  a: string;
}
...
export const gdChrome: Record<GdLang, GdChrome> = {
  ar: {
    ...
    tryLine: "افتح Accio Work وجرّبه أثناء القراءة.",
    backHome: "الرئيسية",
    allGuides: "كل الأدلّة",
    readMore: "اقرأ الدليل",
    hubTitle: "البدء مع Accio Work",
    hubIntro:
      "جديد على Accio Work؟ تأخذك هذه الأدلّة القصيرة من إنشاء الحساب إلى أول نتيجة جاهزة، ثم إلى ربط أدواتك وأتمتة العمل المتكرّر.",
    hubMetaTitle: "أدلّة Accio Work | البدء، أول مهمة، التطبيقات، الأتمتة",
    hubMetaDesc:
      "أدلّة خطوة بخطوة لـ Accio Work: ابدأ، نفّذ أول مهمة، اربط التطبيقات والقنوات، واضبط أتمتة مجدولة. باقة مجانية، بلا بطاقة.",
  },
  en: {
    kicker: "Guide",
    ...
    hubIntro:
      "New to Accio Work? These short guides take you from sign up to your first finished result, then on to connecting your tools and automating the work that repeats.",
    hubMetaTitle: "Accio Work guides | Getting started, first task, apps, automations",
    hubMetaDesc:
      "Step by step guides for Accio Work: get started, run your first task, connect apps and channels, and set up scheduled automations. Free plan, no card.",
  },
  ru: {
    kicker: "Гайд",
    stepsTitle: "Пошагово",
    ...
    hubIntro:
      "Впервые в Accio Work? Эти короткие гайды проведут от регистрации до первого готового результата, а дальше к подключению инструментов и автоматизации того, что повторяется.",
    hubMetaTitle: "Гайды Accio Work | Старт, первая задача, приложения, автоматизации",
    hubMetaDesc:
      "Пошаговые гайды по Accio Work: как начать, выполнить первую задачу, подключить приложения и каналы, настроить автоматизации по расписанию. Бесплатный план, без карты.",
  },
  de: {
    kicker: "Anleitung",
  ...
  it: {
    ...
    hubIntro:
      "Nuovo su Accio Work? Queste brevi guide ti portano dalla registrazione al primo risultato finito, poi al collegamento dei tuoi strumenti e all'automazione del lavoro che si ripete.",
    hubMetaTitle: "Guide di Accio Work | Avvio, prima attività, app, automazioni",
    hubMetaDesc:
      "Guide passo passo per Accio Work: iniziare, eseguire la prima attività, collegare app e canali, impostare automazioni pianificate. Piano gratuito, senza carta.",
  },
  es: {
    kicker: "Guía",
    ...
    hubIntro:
      "¿Nuevo en Accio Work? Estas guías cortas te llevan del registro a tu primer resultado terminado, y luego a conectar tus herramientas y automatizar el trabajo que se repite.",
    hubMetaTitle: "Guías de Accio Work | Empezar, primera tarea, apps, automatizaciones",
    hubMetaDesc:
      "Guías paso a paso de Accio Work: empezar, ejecutar tu primera tarea, conectar apps y canales, configurar automatizaciones programadas. Plan gratis, sin tarjeta.",
  },
  zh: {
    kicker: "指南",
    stepsTitle: "分步操作",
    ...
    hubIntro:
      "第一次用 Accio Work？这些简短指南带你从注册走到第一个完成的结果，再到连接你的工具、把重复的工作自动化。",
    hubMetaTitle: "Accio Work 指南 | 上手、第一个任务、应用、自动化",
    hubMetaDesc:
      "Accio Work 分步指南：上手、运行第一个任务、连接应用与渠道、设置定时自动化。提供免费方案，无需绑卡。",
  },
  pt: {
    kicker: "Guia",
    ...
    hubIntro:
      "Novo no Accio Work? Estes guias curtos levam você do cadastro ao primeiro resultado pronto, e depois a conectar suas ferramentas e automatizar o trabalho que se repete.",
    hubMetaTitle: "Guias do Accio Work | Começar, primeira tarefa, apps, automações",
    hubMetaDesc:
      "Guias passo a passo do Accio Work: começar, executar a primeira tarefa, conectar apps e canais, configurar automações agendadas. Plano grátis, sem cartão.",
  },
  hi: {
    kicker: "गाइड",
    ...
    hubIntro:
      "Accio Work पर नए हैं? ये छोटे गाइड आपको साइन अप से पहले तैयार नतीजे तक, फिर अपने टूल जोड़ने और दोहराए जाने वाले काम को ऑटोमेट करने तक ले जाते हैं।",
    hubMetaTitle: "Accio Work गाइड | शुरुआत, पहला काम, ऐप्स, ऑटोमेशन",
    hubMetaDesc:
      "Accio Work के कदम दर कदम गाइड: शुरू करें, पहला काम चलाएं, ऐप्स और चैनल जोड़ें, शेड्यूल ऑटोमेशन सेट करें। मुफ्त प्लान, कार्ड नहीं।",
  },
  fr: {
    kicker: "Guide",
...
export const gdPages: Record<GdLang, Record<string, GdPage>> = {
  ar: {
    "getting-started": {
      ...
      name: "كيف تبدأ مع Accio Work",
      tagline: "من إنشاء الحساب إلى أول نتيجة في جلسة واحدة",
      metaTitle: "كيف تبدأ مع Accio Work",
      metaDescription:
        "Accio Work وكيل ذكاء اصطناعي ينجز عملاً حقيقياً لا مجرّد محادثة. يأخذك هذا الدليل من إنشاء الحساب إلى أول نتيجة جاهزة لتعرف ما تتوقّعه قبل أن تبدأ.",
      h1: "كيف تبدأ مع Accio Work",
      intro:
        "Accio Work وكيل ذكاء اصطناعي ينجز عملاً حقيقياً لا مجرّد محادثة. يأخذك هذا الدليل من إنشاء الحساب إلى أول نتيجة جاهزة، لتعرف بالضبط ما تتوقّعه قبل أن تبدأ.",
      steps: [
        {
          title: "أنشئ حسابك",
          desc: "سجّل مجاناً بلا بطاقة. تصل إلى مساحة العمل حيث تبدأ كل مهمة.",
        },
        {
          title: "اختر هدفاً",
          desc: "أخبر الوكيل بما تريد بكلمات بسيطة، مثل إيجاد مورّد لمنتج أو كتابة صفحة هبوط.",
        },
        {
          title: "راقبه يخطّط",
          desc: "يقسّم وكيل عام الهدف إلى خطوات ويسلّم أجزاءها لوكلاء مختصين بالتوريد أو الكتابة أو التحليل.",
        },
        {
          title: "وافق وعدّل",
          desc: "ترى الخطة والنتائج أولاً بأول، توافق على ما يصحّ وتعيد توجيه ما لا يناسب.",
        },
        {
          title: "أطلق النتيجة",
          desc: "صدّر المخرجات أو انشرها أو أرسلها. العمل منجَز، لا موصوف فقط.",
        },
      ],
      tips: [
        "ابدأ بهدف واحد واضح بدل طلب غامض",
        "كن محدّداً في المنتج أو السوق أو القناة",
        "يمكنك تشغيله على سطح المكتب أو مباشرة في المتصفح",
      ],
      faq: [
        {
          q: "هل عليّ تثبيت شيء؟",
          a: "لا، يمكنك استخدام Accio Work في المتصفح. وتتوفّر تطبيقات سطح المكتب لـ macOS وWindows أيضاً.",
        },
        { q: "هل البدء مجاني؟", a: "نعم، الباقة المجانية لا تحتاج بطاقة وتتيح تشغيل مهام حقيقية." },
        {
          q: "هل هو روبوت محادثة؟",
          a: "لا، يخطّط وينفّذ المهام بأدوات وبيانات حقيقية، ثم يسلّمك نتيجة جاهزة.",
        },
      ],
    },
    "first-task": {
      slug: "first-task",
      name: "كيف تنفّذ أول مهمة في Accio Work",
      tagline: "اكتب هدفاً يستطيع الوكيل إنجازه فعلاً",
      metaTitle: "كيف تنفّذ أول مهمة في Accio Work",
      metaDescription:
        "الفرق بين نتيجة ضعيفة وأخرى قوية غالباً هو الهدف الذي تعطيه. يبيّن هذا الدليل كيف تصوغ أول مهمة لينفّذها الوكيل من أولها إلى آخرها.",
      h1: "كيف تنفّذ أول مهمة في Accio Work",
      intro:
        "الفرق بين نتيجة ضعيفة وأخرى قوية غالباً هو الهدف الذي تعطيه. يبيّن هذا الدليل كيف تصوغ أول مهمة لينفّذها الوكيل من البداية إلى النهاية ويعيد لك شيئاً تستخدمه.",
      steps: [
        {
          title: "حدّد النتيجة",
          desc: "صِف النتيجة النهائية التي تريدها، لا الخطوات. قل ابنِ صفحة متجر لـ X، لا افتح أداة بناء صفحات.",
        },
        {
          title: "أضِف التفاصيل",
          desc: "سمِّ المنتج والسوق والنبرة أو الميزانية. التفصيل يحوّل التنفيذ العام إلى تنفيذ مفيد.",
        },
        {
          title: "دعه يخطّط ويبدأ",
          desc: "يرتّب الوكيل الخطوات ويشرع في العمل. لا تدير كل نقرة بنفسك.",
        },
        {
          title: "راجِع أثناء العمل",
          desc: "تتدفّق النتائج. وافق على الخطوات الجيّدة، صحّح ما شذّ، فيكمل مساره.",
        },
      ],
      tips: [
        "نتيجة واحدة لكل مهمة أفضل من قائمة أمنيات طويلة",
        "أعطِ مثالاً إن توفّر لديك",
        "إن انحرف التنفيذ، صحّحه مرة ودعه يكمل",
      ],
      faq: [
        {
          q: "ما الذي يصنع أول مهمة جيّدة؟",
          a: "نتيجة واحدة واضحة مع بعض التفاصيل، مثل توريد منتج محدّد أو صياغة صفحة هبوط واحدة.",
        },
        {
          q: "هل أغيّر الاتجاه في منتصف المهمة؟",
          a: "نعم، تراجع وتعيد التوجيه أثناء العمل بدل الانتظار حتى النهاية.",
        },
        {
          q: "كم تستغرق المهمة؟",
          a: "المهام البسيطة تنتهي في دقائق. الأكبر تأخذ وقتاً أطول ويمكنك متابعتها أثناء تنفيذها.",
        },
      ],
    },
    "connect-apps": {
      slug: "connect-apps",
      name: "كيف تربط التطبيقات والقنوات في Accio Work",
      tagline: "دع الوكيل يعمل عبر الأدوات التي تستخدمها أصلاً",
      metaTitle: "كيف تربط التطبيقات والقنوات في Accio Work",
      metaDescription:
        "يصبح Accio Work أكثر نفعاً حين يصل إلى أدواتك. يغطّي هذا الدليل ربط التطبيقات وقنوات المراسلة ليسحب الوكيل البيانات وينفّذ الإجراءات ويصل إليك.",
      h1: "كيف تربط التطبيقات والقنوات في Accio Work",
      intro:
        "يصبح Accio Work أكثر نفعاً حين يصل إلى أدواتك. يغطّي هذا الدليل ربط التطبيقات وقنوات المراسلة ليسحب الوكيل البيانات وينفّذ الإجراءات ويصل إليك حيث تعمل أصلاً.",
      steps: [
        {
          title: "افتح الاتصالات",
          desc: "في مساحة العمل، ابحث عن قسم التطبيقات والقنوات حيث توجد التكاملات.",
        },
        {
          title: "اربط تطبيقاتك",
          desc: "اربط الأدوات التي تستخدمها ليقرأ الوكيل ويتصرّف عبرها بدل النسخ واللصق اليدوي.",
        },
        {
          title: "أضِف قناة",
          desc: "اربط قناة مثل تيليجرام أو Discord أو DingTalk أو فيشو أو WeChat لبدء العمل واستقباله في المحادثة.",
        },
        {
          title: "اختبرها",
          desc: "أرسل مهمة صغيرة عبر القناة أو أحد التطبيقات للتأكّد من عمل الاتصال من طرف إلى طرف.",
        },
      ],
      tips: [
        "اربط ما تحتاجه المهمة فقط لإبقاء الأمور بسيطة",
        "القنوات مفيدة لبدء المهام من هاتفك",
        "أضِف اتصالات أكثر مع نموّ مساراتك",
      ],
      faq: [
        {
          q: "ما القنوات المدعومة؟",
          a: "تيليجرام وDiscord وDingTalk وفيشو وWeChat، لتشغّل المهام من المحادثة.",
        },
        {
          q: "كم تطبيقاً يستطيع الوصول إليه؟",
          a: "يعمل عبر تطبيقات كثيرة، فلا تحتاج المهام متعدّدة الخطوات تسليماً يدوياً.",
        },
        { q: "هل أحتاجها كلّها؟", a: "لا، اربط الأدوات التي تحتاجها مهمة بعينها فقط." },
      ],
    },
    automations: {
      slug: "automations",
      name: "كيف تضبط الأتمتة المجدولة في Accio Work",
      tagline: "حوّل مهمة متكرّرة إلى مهمة تعمل من تلقاء نفسها",
      metaTitle: "كيف تضبط الأتمتة المجدولة في Accio Work",
      metaDescription:
        "متى نجحت مهمة، يمكنك جعلها تتكرّر. يبيّن هذا الدليل كيف تحوّل تنفيذاً لمرة واحدة إلى أتمتة مجدولة ليجري العمل الروتيني وحده.",
      h1: "كيف تضبط الأتمتة المجدولة في Accio Work",
      intro:
        "متى نجحت مهمة، يمكنك جعلها تتكرّر. يبيّن هذا الدليل كيف تحوّل تنفيذاً لمرة واحدة إلى أتمتة مجدولة ليجري العمل الروتيني من تلقاء نفسه.",
      steps: [
        { title: "أنجِح المهمة مرة", desc: "شغّلها يدوياً أولاً وتأكّد أن النتيجة كما تريد." },
        { title: "احفظها كمسار عمل", desc: "احتفظ بالخطوات ليكرّرها الوكيل دون أن تصفها من جديد." },
        { title: "اضبط جدولاً", desc: "اختر موعد تشغيلها، يومياً أو أسبوعياً أو بتوقيتك الخاص." },
        {
          title: "راقِب وحسّن",
          desc: "افحص عمليات التشغيل، عدّل الخطوات، وأبقِها موثوقة مع تغيّر الأمور.",
        },
      ],
      tips: [
        "أتمِت المهام التي تتكرّر بالطريقة نفسها كل مرة",
        "ابدأ بجدول واحد قبل أن تضيف المزيد",
        "راجِع أول عمليات تشغيل لالتقاط الحالات الحدّية",
      ],
      faq: [
        {
          q: "ماذا أستطيع جدولته؟",
          a: "أي مهمة متكرّرة متعدّدة الخطوات، تعمل بالتوقيت الذي تضبطه.",
        },
        { q: "هل تعمل بدوني؟", a: "نعم، بعد جدولتها تنطلق وحدها عبر تطبيقاتك المرتبطة." },
        { q: "هل أغيّرها لاحقاً؟", a: "نعم، عدّل الخطوات أو الجدول في أي وقت." },
      ],
    },
  },
  en: {
    ...
    automations: {
      ...
      metaDescription:
        "Once a task works, you can make it repeat. This guide shows how to turn a one off run into a scheduled automation so routine work happens on its own.",
  ...
  ru: {
    ...
    automations: {
      ...
      metaDescription:
        "Когда задача заработала, её можно сделать повторяющейся. Гайд показывает, как превратить разовый запуск в автоматизацию по расписанию, чтобы рутина шла сама.",
  ...
  zh: {
    "getting-started": {
      ...
      metaDescription:
        "Accio Work 是一个做真实工作的 AI 智能体，而不只是聊天。本指南带你从注册账号走到第一个完成的结果，让你在开始前就清楚会发生什么。",
    ...
    "first-task": {
      ...
      metaDescription:
        "结果强弱的差别，往往在于你给的目标。本指南教你如何组织第一个任务，让智能体从头做到尾，交回你能用的东西。",
      ...
      tips: ["每个任务一个结果，胜过一长串愿望", "有例子就给一个", "若运行跑偏，纠正一次让它继续"],
      faq: [
        {
          q: "什么算好的第一个任务？",
    ...
    "connect-apps": {
      ...
      metaDescription:
        "当 Accio Work 能触达你的工具时，它更有用。本指南讲如何连接应用和消息渠道，让智能体取数据、执行动作，并在你办公的地方找到你。",
    ...
    automations: {
      ...
      metaDescription:
        "任务跑通后，就可以让它重复。本指南教你把一次性运行变成定时自动化，让例行工作自行发生。",
  ...
  hi: {
    ...
    "first-task": {
      ...
      metaDescription:
        "कमजोर और मजबूत नतीजे का फर्क अक्सर आपके दिए लक्ष्य में होता है। यह गाइड बताती है कि पहला काम कैसे लिखें ताकि एजेंट उसे शुरू से अंत तक चलाए और काम की चीज लौटाए।",
    ...
    automations: {
      ...
      metaDescription:
        "जब कोई काम चल जाए, तो उसे दोहराया जा सकता है। यह गाइड बताती है कि एक बार के रन को शेड्यूल ऑटोमेशन में कैसे बदलें ताकि रूटीन खुद चले।",
