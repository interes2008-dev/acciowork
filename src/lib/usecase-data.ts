...
export type UcLang = "en" | "ru" | "de" | "it" | "es" | "zh" | "pt" | "hi" | "fr" | "ar";
export interface UcCap {
  title: string;
  desc: string;
}
export interface UcFaq {
  q: string;
  a: string;
}
...
export const ucChrome: Record<UcLang, UcChrome> = {
  ar: {
    kicker: "حالة استخدام",
    problemTitle: "ما الذي يبطّئ هذا",
    helpTitle: "كيف يتولّاه Accio Work",
    outcomesTitle: "ما ستخرج به",
    faqTitle: "أسئلة شائعة",
    ctaPrimary: "ابدأ مجاناً على Accio Work",
    ctaNote: "باقة مجانية، بلا بطاقة",
    tryLine: "جرّبه على مهمة حقيقية خلال دقائق.",
    backHome: "الرئيسية",
    allUseCases: "كل حالات الاستخدام",
    readMore: "شاهد كيف",
    hubTitle: "ما الذي يمكنك فعله بـ Accio Work",
    hubIntro:
      "Accio Work وكيل ذكاء اصطناعي ينفّذ عملاً حقيقياً من البداية إلى النهاية. اختر المهمة الأقرب إلى عملك وشاهد كيف يتولّى التوريد والبحث والمحتوى والأتمتة.",
    hubMetaTitle: "حالات استخدام Accio Work | توريد، بحث، محتوى، أتمتة",
    hubMetaDesc:
      "اعرف ما يفعله Accio Work في الدروبشيبينغ وإيجاد المورّدين والمحتوى وبحث السوق والأتمتة والأدوات المخصّصة. باقة مجانية للتجربة، بلا بطاقة.",
  },
  en: {
    kicker: "Use case",
    ...
    hubIntro:
      "Accio Work is an AI agent that runs real work end to end. Pick the job closest to yours and see how it handles sourcing, research, content and automation.",
    hubMetaTitle: "Accio Work use cases | Sourcing, research, content, automation",
    hubMetaDesc:
      "See what Accio Work does for dropshipping, supplier sourcing, content, market research, automation and custom tools. Free plan to try, no card.",
  },
  ru: {
    kicker: "Сценарий",
    ...
    hubIntro:
      "Accio Work это AI агент, который выполняет реальную работу от начала до конца. Выберите задачу, близкую к вашей, и посмотрите, как он справляется с закупками, ресёрчем, контентом и автоматизацией.",
    hubMetaTitle: "Сценарии Accio Work | Закупки, ресёрч, контент, автоматизация",
    hubMetaDesc:
      "Что Accio Work делает для дропшиппинга, поиска поставщиков, контента, анализа рынка, автоматизации и кастомных инструментов. Бесплатный план, без карты.",
  },
  de: {
    ...
    hubIntro:
      "Accio Work ist ein AI Agent, der echte Arbeit von Anfang bis Ende erledigt. Wähle die Aufgabe, die deiner am nächsten kommt, und sieh, wie er Sourcing, Recherche, Content und Automatisierung meistert.",
    hubMetaTitle: "Accio Work Anwendungsfälle | Sourcing, Content und mehr",
    hubMetaDesc:
      "Sieh, was Accio Work für Dropshipping, Lieferantensuche, Content, Marktforschung, Automatisierung und eigene Tools leistet. Gratisplan, keine Karte.",
  },
  it: {
    kicker: "Caso d'uso",
    ...
    hubIntro:
      "Accio Work è un agente AI che porta a termine il lavoro dall'inizio alla fine. Scegli il compito più vicino al tuo e guarda come gestisce sourcing, ricerca, contenuti e automazione.",
    hubMetaTitle: "Casi d'uso di Accio Work | Sourcing, ricerca, contenuti, automazione",
    hubMetaDesc:
      "Scopri cosa fa Accio Work per dropshipping, ricerca fornitori, contenuti, ricerca di mercato, automazione e strumenti su misura. Piano gratuito, senza carta.",
  },
  es: {
    kicker: "Caso de uso",
    ...
    hubIntro:
      "Accio Work es un agente de IA que ejecuta trabajo real de principio a fin. Elige la tarea más cercana a la tuya y mira cómo maneja sourcing, investigación, contenido y automatización.",
    hubMetaTitle: "Casos de uso de Accio Work | Sourcing, contenido y más",
    hubMetaDesc:
      "Qué hace Accio Work en dropshipping, sourcing, contenido, estudios de mercado, automatización y herramientas a medida. Plan gratis, sin tarjeta.",
  },
  zh: {
    kicker: "使用场景",
    problemTitle: "卡点在哪里",
    ...
    hubIntro:
      "Accio Work 是一个能把真实工作从头做到尾的 AI 智能体。选择最接近你的任务，看看它如何完成选品、调研、内容和自动化。",
    hubMetaTitle: "Accio Work 使用场景 | 选品、调研、内容、自动化",
    hubMetaDesc:
      "看看 Accio Work 在代发货、供应商寻源、内容、市场调研、自动化和定制工具方面能做什么。提供免费方案，无需绑卡。",
  },
  pt: {
    kicker: "Caso de uso",
    ...
    hubIntro:
      "O Accio Work é um agente de IA que executa trabalho real do início ao fim. Escolha a tarefa mais parecida com a sua e veja como ele lida com sourcing, pesquisa, conteúdo e automação.",
    hubMetaTitle: "Casos de uso do Accio Work | Sourcing, pesquisa, conteúdo, automação",
    hubMetaDesc:
      "Veja o que o Accio Work faz para dropshipping, sourcing de fornecedores, conteúdo, pesquisa de mercado, automação e ferramentas sob medida. Plano grátis, sem cartão.",
  },
  hi: {
    kicker: "उपयोग",
    ...
    hubIntro:
      "Accio Work एक AI एजेंट है जो असली काम शुरू से अंत तक करता है। अपने सबसे करीब का काम चुनें और देखें कि यह सोर्सिंग, रिसर्च, कंटेंट और ऑटोमेशन कैसे संभालता है।",
    hubMetaTitle: "Accio Work उपयोग | सोर्सिंग, रिसर्च, कंटेंट, ऑटोमेशन",
    hubMetaDesc:
      "देखें Accio Work ड्रॉपशिपिंग, सप्लायर सोर्सिंग, कंटेंट, मार्केट रिसर्च, ऑटोमेशन और कस्टम टूल्स के लिए क्या करता है। मुफ्त प्लान, कार्ड नहीं।",
  },
  fr: {
    kicker: "Cas d'usage",
    ...
    hubIntro:
      "Accio Work est un agent IA qui mène un vrai travail de bout en bout. Choisissez la tâche la plus proche de la vôtre et voyez comment il gère le sourcing, la recherche, le contenu et l'automatisation.",
    hubMetaTitle: "Cas d'usage d'Accio Work | Sourcing, contenu et plus",
    hubMetaDesc:
      "Ce qu'Accio Work fait pour le dropshipping, le sourcing, le contenu, l'étude de marché, l'automatisation et les outils sur mesure. Gratuit, sans carte.",
  },
};
...
export const ucPages: Record<UcLang, Record<string, UcPage>> = {
  ar: {
    dropshipping: {
      slug: "dropshipping",
      name: "Accio Work للدروبشيبينغ",
      tagline: "من الاتجاه إلى أول بيع دون تبديل الأدوات",
      metaTitle: "Accio Work للدروبشيبينغ | أداة دروبشيبينغ بالذكاء الاصطناعي",
      metaDescription:
        "الدروبشيبينغ يحيا أو يموت بالسرعة. يدير Accio Work الدورة كاملة: رصد المنتج، وإيجاد المورّد، وبناء القائمة، وصياغة الإعلانات، لتتحرّك والاتجاه لا يزال ساخناً.",
      h1: "Accio Work للدروبشيبينغ",
      intro:
        "الدروبشيبينغ يحيا أو يموت بالسرعة. يدير Accio Work الدورة كاملة: رصد المنتج، وإيجاد المورّد، وبناء القائمة، وصياغة الإعلانات، لتتحرّك والاتجاه لا يزال ساخناً.",
      pain: [
        "الاتجاهات تتحرّك أسرع مما تبحث يدوياً",
        "تدقيق المورّدين يلتهم أياماً قبل أن تبيع شيئاً",
        "القوائم والصور والإعلانات في خمس أدوات مختلفة",
      ],
      caps: [
        {
          title: "اعثر على منتجات تستحقّ البيع",
          desc: "يمسح الوكيل إشارات الطلب والهوامش، لا ما يبدو رائجاً فقط.",
        },
        {
          title: "وفّر مصدر المورّدين ودقّقهم",
          desc: "يسحب مورّدي Alibaba الموثوقين، ويفحص سجلّهم، ويصوغ أول استفسار.",
        },
        { title: "ابنِ القائمة", desc: "صور المنتجات وأوصافها وصفحة متجر جاهزة للنشر." },
        { title: "صُغ مجموعة الإعلانات", desc: "زوايا ونصوص وتصاميم تطلقها في اليوم نفسه." },
      ],
      outcomes: [
        "قائمة مختصرة بمنتجات ذات هامش حقيقي",
        "مورّدون مدقّقون باستفسارات مُرسَلة",
        "صفحة متجر جاهزة للنشر",
        "نصوص وتصاميم إعلانات للإطلاق",
      ],
      faq: [
        {
          q: "هل يعثر Accio Work على منتجات الدروبشيبينغ؟",
          a: "نعم، يمسح إشارات الطلب والهامش ويعيد قائمة مختصرة، ثم يوفّر المورّدين لما تختاره.",
        },
        {
          q: "هل يعمل مع مورّدي Alibaba؟",
          a: "نعم، يعتمد اكتشاف المورّدين وتدقيقهم على بيانات تجارة Alibaba الحقيقية، ويمكنه صياغة أول استفسار.",
        },
        {
          q: "هل هناك باقة مجانية؟",
          a: "نعم، ابدأ مجاناً بلا بطاقة ونفّذ مساراً كاملاً من المنتج إلى المورّد.",
        },
      ],
    },
    sourcing: {
      slug: "sourcing",
      name: "Accio Work لإيجاد المورّدين",
      tagline: "مورّدون موثوقون واستفسارات مُرسَلة، بلا أخذ وردّ",
      metaTitle: "Accio Work لإيجاد المورّدين | إيجاد مورّدين بالذكاء الاصطناعي",
      metaDescription:
        "التوريد بطيء لأن العمل يدوي: بحث، ومقارنة، ومراسلة، وملاحقة. يتولّى Accio Work الجهد، يُظهر مورّدين موثوقين ويصوغ التواصل، لتقرّر بدل أن تنقّب.",
      h1: "Accio Work لإيجاد المورّدين",
      intro:
        "التوريد بطيء لأن العمل يدوي: بحث، ومقارنة، ومراسلة، وملاحقة. يتولّى Accio Work الجهد، يُظهر مورّدين موثوقين ويصوغ رسائل التواصل، لتقضي وقتك في القرار لا في التنقيب.",
      pain: [
        "ألسنة تبويب لا تنتهي لمقارنة مورّدين لا يمكنك التحقّق منهم",
        "كتابة رسالة الاستفسار نفسها مراراً",
        "لا طريقة سهلة لمقارنة عروض الأسعار جنباً إلى جنب",
      ],
      caps: [
        {
          title: "اكتشف مورّدين موثوقين",
          desc: "يبحث في بيانات تجارة Alibaba الحقيقية ويرشّح حسب السجلّ.",
        },
        {
          title: "قارن على ما يهمّ",
          desc: "السعر والحد الأدنى للطلب ومعدّل الردّ والسجلّ في عرض واحد.",
        },
        { title: "أرسِل أول استفسار", desc: "يصوغ ويرسل رسالة واضحة مضبوطة لكل مورّد." },
        { title: "تابِع الردود", desc: "يجمع عروض الأسعار والمحادثات معاً لتقرّر بسرعة." },
      ],
      outcomes: [
        "قائمة مختصرة بمورّدين مدقّقين",
        "استفسارات مصوغة ومُرسَلة",
        "عروض أسعار مصفوفة للمقارنة",
        "اختيار واضح بأسبابه",
      ],
      faq: [
        {
          q: "كيف يدقّق Accio Work المورّدين؟",
          a: "يستخدم بيانات تجارة Alibaba الحقيقية لفحص السجلّ ومعدّل الردّ قبل أن تتواصل.",
        },
        {
          q: "هل يتواصل مع المورّدين نيابةً عنّي؟",
          a: "نعم، يصوغ ويمكنه إرسال أول استفسار، ثم يجمع الردود معاً.",
        },
        {
          q: "هل أحتاج باقة مدفوعة للتجربة؟",
          a: "لا، تتيح الباقة المجانية تنفيذ مهمة توريد بلا بطاقة.",
        },
      ],
    },
    content: {
      slug: "content",
      name: "Accio Work للمحتوى والتسويق",
      tagline: "صفحات هبوط ونصوص منتجات ومنشورات، تُنشر وفق جدول",
      metaTitle: "محتوى تجارة إلكترونية بالذكاء الاصطناعي | Accio Work",
      metaDescription:
        "محتوى التسويق سير لا يتوقّف. يكتب Accio Work صفحة الهبوط وبطاقات المنتجات والمنشورات الاجتماعية، ثم يجدولها، لتبقى قنواتك حيّة دون أن تلازم لوحة المفاتيح.",
      h1: "Accio Work للمحتوى والتسويق",
      intro:
        "محتوى التسويق سير لا يتوقّف. يكتب Accio Work صفحة الهبوط وبطاقات المنتجات والمنشورات الاجتماعية، ثم يجدولها، لتبقى قنواتك حيّة دون أن تلازم لوحة المفاتيح طوال اليوم.",
      pain: [
        "صفحة بيضاء في كل إطلاق منتج",
        "إعادة كتابة النصّ نفسه لخمس قنوات",
        "النشر يدوياً، منشوراً منشوراً",
      ],
      caps: [
        { title: "اكتب صفحة الهبوط", desc: "بنية ونصوص ودعوات فعل جاهزة للنشر." },
        { title: "املأ بطاقات المنتجات", desc: "عناوين ونقاط وأوصاف تطابق كتالوجك." },
        { title: "اصنع منشورات اجتماعية", desc: "منشورات جاهزة للمنصّات بمقدّمات جاذبة لا حشو." },
        { title: "جدوِل وانشر", desc: "يصفّ المنشورات وينشرها في الأوقات التي تحدّدها." },
      ],
      outcomes: [
        "صفحة هبوط جاهزة",
        "بطاقات منتجات مملوءة",
        "أسبوع من المنشورات الاجتماعية",
        "جدول نشر يعمل",
      ],
      faq: [
        {
          q: "هل ينشر Accio Work المحتوى نيابةً عنّي؟",
          a: "نعم، يمكنه جدولة المحتوى ونشره على قنواتك، لا صياغة النصّ فقط.",
        },
        { q: "هل يطابق النصّ علامتي؟", a: "تعطيه نبرتك ومنتجاتك فيكتب وفقها لا حشواً عامّاً." },
        { q: "هل التجربة مجانية؟", a: "نعم، ابدأ بالباقة المجانية بلا بطاقة." },
      ],
    },
    "market-research": {
      slug: "market-research",
      name: "Accio Work لبحث السوق",
      tagline: "المنافسون والطلب والتسعير، مقروءة لأجلك",
      metaTitle: "Accio Work لبحث السوق | بحث سوق بالذكاء الاصطناعي",
      metaDescription:
        "القرارات الجيّدة تبدأ بقراءة واضحة للسوق. يجمع Accio Work تحرّكات المنافسين وإشارات الطلب والتسعير، ثم يسلّمك ملخّصاً تتصرّف بناءً عليه.",
      h1: "Accio Work لبحث السوق",
      intro:
        "القرارات الجيّدة تبدأ بقراءة واضحة للسوق. يجمع Accio Work تحرّكات المنافسين وإشارات الطلب والتسعير، ثم يسلّمك ملخّصاً تتصرّف بناءً عليه بدل كومة من ألسنة التبويب.",
      pain: [
        "بحث مبعثر بين التبويبات ولقطات الشاشة",
        "صفحات منافسين تفحصها يدوياً كل أسبوع",
        "تخمين لموضع الطلب والسعر",
      ],
      caps: [
        { title: "ارسم خريطة المنافسين", desc: "من يبيع، وبأي سعر، وبأي زاوية." },
        { title: "اقرأ إشارات الطلب", desc: "أين يرتفع الاهتمام وأين يخبو." },
        { title: "تابِع التسعير", desc: "كيف يسعّر السوق منتجاً وأين الفجوات." },
        { title: "لخّص القرار", desc: "موجز قصير بالقرار، لا بيانات خام." },
      ],
      outcomes: ["خريطة منافسين", "قراءة للطلب", "رؤية للتسعير", "موجز تتصرّف بناءً عليه"],
      faq: [
        {
          q: "ماذا يستطيع Accio Work أن يبحث؟",
          a: "المنافسون وإشارات الطلب والتسعير لمنتج أو سوق متخصّص، ملخّصة في موجز قصير.",
        },
        {
          q: "هل يستخدم بيانات حيّة؟",
          a: "يسحب مصادر حالية وبيانات تجارة Alibaba الحقيقية لا المعرفة المخزّنة وحدها.",
        },
        { q: "هل أجرّبه مجاناً؟", a: "نعم، تنفّذ الباقة المجانية مهمة بحث بلا بطاقة." },
      ],
    },
    automation: {
      slug: "automation",
      name: "Accio Work لأتمتة سير العمل",
      tagline: "مهام متكرّرة ينفّذها الوكيل وفق جدول",
      metaTitle: "Accio Work لأتمتة سير العمل | أتمتة سير عمل بالذكاء الاصطناعي",
      metaDescription:
        "المهام التي تلتهم أسبوعك هي نفسها كل مرة عادةً. يحوّلها Accio Work إلى أتمتة تعمل وفق جدول وعبر التطبيقات التي تستخدمها أصلاً، ليجري الروتين وحده.",
      h1: "Accio Work لأتمتة سير العمل",
      intro:
        "المهام التي تلتهم أسبوعك هي نفسها كل مرة عادةً. يحوّلها Accio Work إلى أتمتة تعمل وفق جدول وعبر التطبيقات التي تستخدمها أصلاً، ليجري العمل الروتيني من تلقاء نفسه.",
      pain: [
        "الخطوات اليدوية نفسها كل يوم",
        "نسخ ولصق بين تطبيقات لا تتحدّث",
        "عمل لا يحدث إلا حين تتذكّره",
      ],
      caps: [
        { title: "ابنِ سير العمل", desc: "صِف المهمة فيرتّب الوكيل الخطوات." },
        { title: "اربط تطبيقاتك", desc: "يعمل عبر الأدوات التي تشغّلها أصلاً." },
        { title: "شغّل وفق جدول", desc: "اضبطه فتنطلق المهمة دونك." },
        { title: "راقِب وعدّل", desc: "شاهد عمليات التشغيل، عدّل الخطوات، أبقِها موثوقة." },
      ],
      outcomes: ["أتمتة تعمل", "تطبيقات مرتبطة", "جدول يعمل", "ساعات تعود كل أسبوع"],
      faq: [
        {
          q: "ماذا يستطيع Accio Work أن يؤتمت؟",
          a: "مهام متكرّرة متعدّدة الخطوات عبر تطبيقاتك، تعمل بجدول تضبطه.",
        },
        {
          q: "هل يتّصل بأدوات أخرى؟",
          a: "نعم، يعمل عبر تطبيقات كثيرة فلا تحتاج الخطوات نسخاً ولصقاً يدوياً.",
        },
        { q: "هل هناك باقة مجانية؟", a: "نعم، ابدأ مجاناً بلا بطاقة وابنِ أول أتمتة لك." },
      ],
    },
    "custom-tools": {
      slug: "custom-tools",
      name: "Accio Work للأدوات المخصّصة",
      tagline: "أدوات داخلية صغيرة، تُبنى بوصفها",
      metaTitle: "Accio Work للأدوات المخصّصة | أدوات مخصّصة بالذكاء الاصطناعي",
      metaDescription:
        "أحياناً الأداة التي تحتاجها غير موجودة بعد. يبني Accio Work أدوات داخلية صغيرة من وصف بسيط، لتحصل على الحاسبة أو أداة التتبّع أو اللوحة دون طابور مطوّرين.",
      h1: "Accio Work للأدوات المخصّصة",
      intro:
        "أحياناً الأداة التي تحتاجها غير موجودة بعد. يبني Accio Work أدوات داخلية صغيرة من وصف بسيط، لتحصل على الحاسبة أو أداة التتبّع أو اللوحة التي احتجتها دون طابور مطوّرين.",
      pain: [
        "الأدوات الجاهزة لا تناسب المهمة بدقّة أبداً",
        "احتياجات داخلية بسيطة تنتظر خلف قائمة مهام التطوير",
        "جداول ممطوطة أبعد بكثير مما ينبغي",
      ],
      caps: [
        { title: "صِف الأداة", desc: "قل ما ينبغي أن تفعله بكلمات بسيطة." },
        { title: "احصل على نسخة تعمل", desc: "ينتج الوكيل شيئاً تستخدمه، لا مواصفات." },
        { title: "اربط بياناتك", desc: "يتّصل بالمصادر التي تحتاجها الأداة." },
        { title: "طوّر بالمحادثة", desc: "غيّرها بالطلب، بلا إعادة بناء من الصفر." },
      ],
      outcomes: ["أداة داخلية تعمل", "بياناتك موصولة", "تغييرات بالمحادثة", "بلا طابور مطوّرين"],
      faq: [
        {
          q: "أي نوع من الأدوات يستطيع بناءه؟",
          a: "أدوات داخلية صغيرة كالحاسبات وأدوات التتبّع واللوحات البسيطة، من وصف بسيط.",
        },
        { q: "هل عليّ أن أبرمج؟", a: "لا، تصف ما تريد وتعدّله بالمحادثة." },
        { q: "هل أجرّبه مجاناً؟", a: "نعم، تتيح الباقة المجانية بناء أول أداة بلا بطاقة." },
      ],
    },
  },
  en: {
    ...
    "market-research": {
      ...
      outcomes: ["A competitor map", "A demand read", "A pricing view", "A brief you can act on"],
      faq: [
        {
  ...
  zh: {
    dropshipping: {
      ...
      metaDescription:
        "代发货成败在于速度。Accio Work 跑完整个闭环，发现商品、找到供应商、搭好详情页并起草广告，让你在趋势还热时就出手。",
      h1: "Accio Work 助力代发货",
      intro:
        "代发货成败在于速度。Accio Work 跑完整个闭环，发现商品、找到供应商、搭好详情页并起草广告，让你在趋势还热时就出手。",
      pain: [
    ...
    sourcing: {
      ...
      metaDescription:
        "寻源慢，是因为全靠手动：搜索、比较、发邮件、追进度。Accio Work 承担这些跑腿活，呈现已核验的供应商并起草沟通，让你把时间花在决策上，而不是翻找。",
    ...
    content: {
      ...
      metaDescription:
        "营销内容像跑步机。Accio Work 写好落地页、商品卡和社媒帖子，再排期发布，让你的渠道保持活跃，无需整天守着键盘。",
      h1: "Accio Work 助力内容与营销",
      intro:
        "营销内容像跑步机。Accio Work 写好落地页、商品卡和社媒帖子，再排期发布，让你的渠道保持活跃，无需整天守着键盘。",
      pain: ["每次上新品都面对一张白纸", "同一段文案要为五个渠道重写", "一条条手动发布"],
      caps: [
        {
          title: "写好落地页",
      ...
      outcomes: ["一个完成的落地页", "填好的商品卡", "一周的社媒帖子", "正在运行的发布排期"],
      faq: [
        {
    ...
    "market-research": {
      ...
      metaDescription:
        "好决策始于看清市场。Accio Work 汇集竞品动作、需求信号和定价，再交给你一份可落地的摘要，而不是一堆标签页。",
      h1: "Accio Work 助力市场调研",
      intro:
        "好决策始于看清市场。Accio Work 汇集竞品动作、需求信号和定价，再交给你一份可落地的摘要，而不是一堆标签页。",
      pain: ["调研散落在标签页和截图里", "每周手动查看竞品页面", "对需求和价格只能靠猜"],
      caps: [
        {
          title: "梳理竞品格局",
      ...
      outcomes: ["一张竞品地图", "一份需求解读", "一份定价视图", "一份可执行的简报"],
      faq: [
        {
          q: "Accio Work 能调研什么？",
    ...
    automation: {
      ...
      metaDescription:
        "吃掉你一周的任务，往往每次都一样。Accio Work 把它们变成自动化，按计划运行并贯穿你已在用的应用，让例行工作自行完成。",
      h1: "Accio Work 助力工作流自动化",
      intro:
        "吃掉你一周的任务，往往每次都一样。Accio Work 把它们变成自动化，按计划运行并贯穿你已在用的应用，让例行工作自行完成。",
      pain: ["每天都是同样的手动步骤", "在互不相通的应用间复制粘贴", "只有你记得时才会发生的工作"],
      caps: [
        {
          title: "搭建工作流",
          desc: "描述任务，智能体排好步骤。",
      ...
      outcomes: ["一套可用的自动化", "已连接的应用", "一个持续运行的排期", "每周省回的时间"],
      faq: [
        {
          q: "Accio Work 能自动化什么？",
    ...
    "custom-tools": {
      ...
      metaDescription:
        "有时你要的工具还不存在。Accio Work 根据一段普通描述就能造出小型内部工具，让你无需排队等开发，就有了计算器、跟踪器或仪表盘。",
      ...
      outcomes: ["一个可用的内部工具", "接入的你的数据", "对话即可修改", "无需排队开发"],
      faq: [
        {
          q: "它能做哪类工具？",
  ...
  hi: {
    ...
    "market-research": {
      ...
      outcomes: ["प्रतियोगियों का नक्शा", "मांग की समझ", "कीमत का दृश्य", "काम लायक ब्रीफ"],
      faq: [
        {
    ...
    "custom-tools": {
      ...
      outcomes: ["एक चलता आंतरिक टूल", "जुड़ा हुआ आपका डेटा", "चैट से बदलाव", "कोई डेव कतार नहीं"],
      faq: [
        {
