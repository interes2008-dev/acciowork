...
const en: Dict = {
  ...
  pricing: {
    eyebrow: "Pricing",
    heading: "Start free. Pay only when the agent does the heavy lifting.",
    subheading:
      "No card and no trial clock. Hand it one real task tonight and see for yourself what a full AI team feels like.",
    perksTitle: "What's inside",
    note: "Prices and credit costs are set by Accio and can change. Check the app for current details.",
    stepsTitle: "Your first 10 minutes",
    steps: [
      "Install and sign in. No card asked.",
      "Describe one real task in plain words.",
      "Watch the agent open sites, compare suppliers and report back.",
    ],
    plans: [
      {
        name: "Free",
        ...
        tagline:
          "A full AI agent, not a stripped-down demo. Enough to launch a real project tonight.",
        features: [
          "24/7 general AI agent",
          "50+ one-click integrations",
          "Browser automation that clicks and fills forms for you",
          "Market research on real trade data",
        ],
        unlock: "Try first: ask it for 5 verified suppliers of your product.",
        cta: "Start free now",
      },
      {
        name: "Pro",
        price: "Pay per task",
        priceNote: "credits only for heavy jobs",
        badge: "Our pick",
        tagline:
          "What sellers switch on once the free agent proves itself. Specialists take whole jobs off your plate.",
        features: [
          "Everything in Free",
          "Senior specialists for sourcing, design and copy",
          "Extra data from Amazon, TikTok and YouTube",
          "Scheduled automations and team seats",
        ],
        unlock: "Unlocks agents that keep working on a schedule while you sleep.",
        cta: "Unlock Pro",
        highlight: true,
      },
      {
        name: "Enterprise",
        price: "Custom",
        priceNote: "shaped with our team",
        tagline: "For teams that want the agent wired into their own stack and rules.",
        features: [
          "Everything in Pro",
          "Priority support",
        ...
        unlock: "Includes a guided setup with the Accio team.",
        cta: "Try it first",
      },
    ],
  },
...
const ru: Dict = {
  ...
  pricing: {
    eyebrow: "Тарифы",
    heading: "Начните бесплатно. Платите, только когда агент берёт на себя тяжёлую работу.",
    subheading:
      "Без карты и без таймера пробного периода. Дайте ему одну реальную задачу сегодня вечером и почувствуйте, каково работать с целой ИИ-командой.",
    perksTitle: "Что внутри",
    note: "Цены и стоимость кредитов устанавливает Accio, они могут меняться. Актуальные условия смотрите в приложении.",
    stepsTitle: "Ваши первые 10 минут",
    steps: [
      "Установите и войдите. Карту никто не спросит.",
      "Опишите одну реальную задачу простыми словами.",
      "Смотрите, как агент открывает сайты, сравнивает поставщиков и присылает отчёт.",
    ],
    plans: [
      {
        name: "Free",
        price: "$0",
        priceNote: "без карты и таймера",
        tagline:
          "Полноценный ИИ-агент, а не урезанное демо. Хватит, чтобы запустить реальный проект уже сегодня.",
        features: [
          "ИИ-агент 24/7",
          "50+ интеграций в один клик",
          "Автоматизация браузера: кликает и заполняет формы за вас",
          "Исследование рынка на реальных торговых данных",
        ],
        unlock: "Попробуйте первым делом: попросите найти 5 проверенных поставщиков вашего товара.",
        cta: "Начать бесплатно",
      },
      {
        name: "Pro",
        price: "Оплата за задачу",
        priceNote: "кредиты только за тяжёлые задачи",
        badge: "Наш выбор",
        tagline:
          "Его включают, когда бесплатный агент доказал пользу. Специалисты забирают целые задачи с ваших плеч.",
        features: [
          "Всё из Free",
          "Старшие специалисты по закупкам, дизайну и текстам",
          "Данные Amazon, TikTok и YouTube",
          "Автоматизации по расписанию и командный доступ",
        ],
        unlock: "Открывает агентов, которые работают по расписанию, пока вы спите.",
        cta: "Открыть Pro",
        highlight: true,
      },
      {
        name: "Enterprise",
        price: "Индивидуально",
        priceNote: "настраиваем вместе с командой",
        tagline: "Для команд, которым нужно встроить агента в свои системы и правила.",
        features: [
          "Всё из Pro",
        ...
        unlock: "Включает сопровождаемую настройку с командой Accio.",
        cta: "Сначала попробовать",
      },
    ],
  },
  compareChat: {
...
const de: Dict = {
  ...
  pricing: {
    eyebrow: "Preise",
    heading: "Kostenlos starten. Zahlen nur, wenn der Agent die schwere Arbeit macht.",
    subheading:
      "Keine Karte, keine ablaufende Testphase. Gib ihm heute Abend eine echte Aufgabe und erlebe, wie sich ein ganzes KI-Team anfühlt.",
    perksTitle: "Das steckt drin",
    note: "Preise und Credit-Kosten legt Accio fest, sie können sich ändern. Aktuelle Details stehen in der App.",
    stepsTitle: "Deine ersten 10 Minuten",
    steps: [
      "Installieren und anmelden. Keine Karte nötig.",
      "Eine echte Aufgabe in einfachen Worten beschreiben.",
      "Zusehen, wie der Agent Seiten öffnet, Lieferanten vergleicht und berichtet.",
    ],
    plans: [
      {
        name: "Free",
        price: "$0",
        priceNote: "ohne Karte, ohne Ablaufdatum",
        tagline:
          "Ein vollwertiger KI-Agent, keine abgespeckte Demo. Genug, um heute Abend ein echtes Projekt zu starten.",
        features: [
          "KI-Agent rund um die Uhr",
          "50+ Integrationen per Klick",
          "Browser-Automatisierung, die für dich klickt und Formulare ausfüllt",
          "Marktanalyse mit echten Handelsdaten",
        ],
        unlock: "Probier zuerst: Lass dir 5 geprüfte Lieferanten für dein Produkt suchen.",
        cta: "Jetzt kostenlos starten",
      },
      {
        name: "Pro",
        price: "Pro Aufgabe",
        priceNote: "Credits nur für schwere Jobs",
        badge: "Unsere Wahl",
        tagline:
          "Das schalten Händler ein, sobald der kostenlose Agent überzeugt hat. Spezialisten nehmen dir ganze Aufgaben ab.",
        features: [
          "Alles aus Free",
          "Senior-Spezialisten für Einkauf, Design und Texte",
          "Zusätzliche Daten von Amazon, TikTok und YouTube",
          "Geplante Automatisierungen und Team-Plätze",
        ],
        unlock: "Schaltet Agenten frei, die nach Zeitplan weiterarbeiten, während du schläfst.",
      ...
      },
      {
        name: "Enterprise",
        price: "Individuell",
        priceNote: "gemeinsam mit unserem Team",
        tagline: "Für Teams, die den Agenten in eigene Systeme und Regeln einbinden wollen.",
        features: [
          "Alles aus Pro",
        ...
        unlock: "Inklusive begleiteter Einrichtung mit dem Accio-Team.",
        cta: "Erst ausprobieren",
      },
    ],
  },
  compareChat: {
...
const it: Dict = {
  ...
  pricing: {
    eyebrow: "Prezzi",
    heading: "Inizia gratis. Paghi solo quando l'agente fa il lavoro pesante.",
    subheading:
      "Niente carta, niente prova a tempo. Affidagli un compito vero stasera e scopri cosa significa avere un intero team di IA.",
    perksTitle: "Cosa include",
    note: "Prezzi e costi dei crediti sono stabiliti da Accio e possono cambiare. Controlla l'app per i dettagli aggiornati.",
    stepsTitle: "I tuoi primi 10 minuti",
    steps: [
      "Installa e accedi. Nessuna carta richiesta.",
      "Descrivi un compito reale con parole semplici.",
      "Guarda l'agente aprire siti, confrontare fornitori e riferirti tutto.",
    ],
    plans: [
      {
        name: "Free",
        price: "$0",
        priceNote: "senza carta, senza scadenza",
        tagline:
          "Un agente IA completo, non una demo ridotta. Abbastanza per lanciare un progetto vero stasera.",
        features: [
          "Agente IA attivo 24/7",
          "50+ integrazioni con un clic",
          "Automazione del browser che clicca e compila moduli per te",
          "Ricerche di mercato su dati commerciali reali",
        ],
        unlock: "Prova subito: chiedigli 5 fornitori verificati per il tuo prodotto.",
        cta: "Inizia gratis ora",
      },
      {
        name: "Pro",
        price: "A consumo",
        priceNote: "crediti solo per i lavori pesanti",
        badge: "La nostra scelta",
        tagline:
          "Lo attivano i venditori quando l'agente gratuito ha dimostrato il suo valore. Gli specialisti si prendono interi lavori.",
        features: [
          "Tutto di Free",
          "Specialisti senior per sourcing, design e testi",
          "Dati extra da Amazon, TikTok e YouTube",
          "Automazioni programmate e posti per il team",
        ],
        unlock: "Sblocca agenti che lavorano secondo un programma mentre dormi.",
        cta: "Sblocca Pro",
        highlight: true,
      },
      {
        name: "Enterprise",
        price: "Su misura",
        priceNote: "definito con il nostro team",
        tagline:
          "Per i team che vogliono l'agente integrato nei propri sistemi e nelle proprie regole.",
        features: [
          "Tutto di Pro",
        ...
        unlock: "Include una configurazione guidata con il team Accio.",
        cta: "Prima provalo",
      },
    ],
  },
...
const es: Dict = {
  ...
  pricing: {
    eyebrow: "Precios",
    heading: "Empieza gratis. Paga solo cuando el agente hace el trabajo pesado.",
    subheading:
      "Sin tarjeta y sin reloj de prueba. Dale una tarea real esta noche y descubre lo que se siente tener un equipo de IA completo.",
    perksTitle: "Qué incluye",
    note: "Los precios y el coste de los créditos los fija Accio y pueden cambiar. Consulta la app para ver los detalles actuales.",
    stepsTitle: "Tus primeros 10 minutos",
    steps: [
      "Instala e inicia sesión. Nadie te pide tarjeta.",
      "Describe una tarea real con palabras sencillas.",
      "Mira cómo el agente abre sitios, compara proveedores y te informa.",
    ],
    plans: [
      {
        name: "Free",
        price: "$0",
        priceNote: "sin tarjeta, sin fecha límite",
        tagline:
          "Un agente de IA completo, no una demo recortada. Suficiente para lanzar un proyecto real esta noche.",
        features: [
          "Agente de IA 24/7",
          "Más de 50 integraciones en un clic",
          "Automatización del navegador que hace clic y rellena formularios por ti",
          "Estudios de mercado con datos comerciales reales",
        ],
        unlock: "Prueba primero: pídele 5 proveedores verificados para tu producto.",
        cta: "Empieza gratis ya",
      },
      {
        name: "Pro",
        price: "Pago por uso",
        priceNote: "créditos solo para tareas pesadas",
        badge: "Nuestra elección",
        tagline:
          "Lo activan los vendedores cuando el agente gratuito demuestra lo que vale. Los especialistas se llevan trabajos enteros.",
        features: [
          "Todo lo de Free",
          "Especialistas sénior en sourcing, diseño y textos",
          "Datos extra de Amazon, TikTok y YouTube",
          "Automatizaciones programadas y plazas de equipo",
        ],
        unlock: "Desbloquea agentes que siguen trabajando según un horario mientras duermes.",
        cta: "Desbloquear Pro",
        highlight: true,
      },
      {
        name: "Enterprise",
        price: "A medida",
        priceNote: "definido con nuestro equipo",
        tagline: "Para equipos que quieren el agente integrado en sus propios sistemas y reglas.",
        features: [
          "Todo lo de Pro",
          "Soporte prioritario",
        ...
        unlock: "Incluye una configuración guiada con el equipo de Accio.",
        cta: "Pruébalo primero",
      },
    ],
  },
  compareChat: {
...
const zh: Dict = {
  ...
  pricing: {
    eyebrow: "价格",
    heading: "免费开始。只有代理处理重活时才付费。",
    subheading:
      "无需银行卡，也没有试用倒计时。今晚交给它一个真实任务，亲自感受拥有一整支 AI 团队是什么体验。",
    perksTitle: "包含内容",
    note: "价格和积分消耗由 Accio 设定，可能会调整。最新信息请以应用内为准。",
    stepsTitle: "你的前 10 分钟",
    steps: [
      "安装并登录，无需绑卡。",
      "用大白话描述一个真实任务。",
      "看着代理打开网站、比较供应商并向你汇报。",
    ...
    plans: [
      {
        ...
        price: "$0",
        priceNote: "无需绑卡，不限时",
        tagline: "完整的 AI 代理，而不是缩水版演示。今晚就足以启动一个真实项目。",
        features: [
          "全天候 AI 代理",
          "50+ 一键集成",
          "浏览器自动化，替你点击和填写表单",
      ...
      },
      {
        ...
        priceNote: "积分只用于重型任务",
        badge: "我们的推荐",
        tagline: "免费代理证明价值后，卖家就会开启它。专家代理直接接手整项工作。",
        features: [
          "包含 Free 全部功能",
          "采购、设计和文案资深专家",
          "来自 Amazon、TikTok、YouTube 的额外数据",
          "定时自动化与团队席位",
        ],
        unlock: "解锁按计划持续工作的代理，你睡觉时它也在干活。",
        cta: "解锁 Pro",
        highlight: true,
      },
      {
        ...
        price: "定制",
        priceNote: "与我们团队共同制定",
        tagline: "适合希望把代理接入自有系统和规则的团队。",
        features: ["包含 Pro 全部功能", "优先支持", "高级安全与管控", "专属上手指导"],
        unlock: "包含 Accio 团队陪同完成的配置。",
        cta: "先试用",
      },
    ],
  },
...
const pt: Dict = {
  ...
  pricing: {
    eyebrow: "Preços",
    heading: "Comece grátis. Pague só quando o agente faz o trabalho pesado.",
    subheading:
      "Sem cartão e sem relógio de teste. Dê a ele uma tarefa real hoje à noite e sinta como é ter uma equipe de IA completa.",
    perksTitle: "O que inclui",
    note: "Preços e custos de créditos são definidos pela Accio e podem mudar. Confira o app para os detalhes atuais.",
    stepsTitle: "Seus primeiros 10 minutos",
    steps: [
      "Instale e entre. Ninguém pede cartão.",
      "Descreva uma tarefa real em palavras simples.",
      "Veja o agente abrir sites, comparar fornecedores e trazer o relatório.",
    ],
    plans: [
      {
        name: "Free",
        ...
        tagline:
          "Um agente de IA completo, não uma demo limitada. O suficiente para lançar um projeto real hoje à noite.",
        features: [
          "Agente de IA 24/7",
          "Mais de 50 integrações com um clique",
          "Automação de navegador que clica e preenche formulários por você",
          "Pesquisa de mercado com dados reais de comércio",
        ],
        unlock: "Teste primeiro: peça 5 fornecedores verificados para o seu produto.",
        cta: "Começar grátis agora",
      },
      {
        name: "Pro",
        price: "Por tarefa",
        priceNote: "créditos só para trabalhos pesados",
        badge: "Nossa escolha",
        tagline:
          "Os vendedores ativam quando o agente gratuito prova seu valor. Especialistas assumem trabalhos inteiros.",
        features: [
          "Tudo do Free",
          "Especialistas sênior em sourcing, design e textos",
          "Dados extras de Amazon, TikTok e YouTube",
          "Automações agendadas e vagas para equipe",
        ],
        unlock: "Libera agentes que seguem trabalhando no horário programado enquanto você dorme.",
        cta: "Liberar o Pro",
        highlight: true,
      },
      {
        name: "Enterprise",
        price: "Sob medida",
        priceNote: "definido com nossa equipe",
        tagline: "Para equipes que querem o agente integrado aos próprios sistemas e regras.",
        features: [
          "Tudo do Pro",
          "Suporte prioritário",
        ...
        unlock: "Inclui uma configuração guiada com a equipe Accio.",
        cta: "Experimente primeiro",
      },
    ],
  },
  compareChat: {
...
const hi: Dict = {
  ...
  pricing: {
    eyebrow: "कीमतें",
    heading: "मुफ़्त में शुरू करें। भुगतान तभी, जब एजेंट भारी काम करे।",
    subheading:
      "न कार्ड, न ट्रायल की घड़ी। आज रात इसे एक असली काम दें और खुद महसूस करें कि पूरी AI टीम के साथ काम करना कैसा लगता है।",
    perksTitle: "इसमें क्या है",
    note: "कीमतें और क्रेडिट की लागत Accio तय करता है और ये बदल सकती हैं। ताज़ा जानकारी ऐप में देखें।",
    stepsTitle: "आपके पहले 10 मिनट",
    steps: [
      "इंस्टॉल करें और साइन इन करें। कोई कार्ड नहीं मांगा जाता।",
      "एक असली काम आसान शब्दों में बताएं।",
      "देखें कि एजेंट साइटें खोलता है, सप्लायरों की तुलना करता है और रिपोर्ट देता है।",
    ],
    plans: [
      {
        name: "Free",
        price: "$0",
        priceNote: "न कार्ड, न समय सीमा",
        tagline:
          "पूरा AI एजेंट, कटा हुआ डेमो नहीं। आज रात एक असली प्रोजेक्ट शुरू करने के लिए काफ़ी।",
        features: [
          "24/7 AI एजेंट",
          "एक क्लिक में 50+ इंटीग्रेशन",
          "ब्राउज़र ऑटोमेशन जो आपके लिए क्लिक करता है और फ़ॉर्म भरता है",
          "असली ट्रेड डेटा पर मार्केट रिसर्च",
        ],
        unlock: "पहले यह आज़माएं: अपने प्रोडक्ट के लिए 5 सत्यापित सप्लायर मांगें।",
        cta: "अभी मुफ़्त शुरू करें",
      },
      {
        name: "Pro",
        price: "प्रति काम भुगतान",
        priceNote: "क्रेडिट सिर्फ़ भारी कामों पर",
        badge: "हमारी पसंद",
        tagline:
          "मुफ़्त एजेंट पर भरोसा बनने के बाद सेलर इसे चालू करते हैं। विशेषज्ञ पूरे काम अपने हाथ में ले लेते हैं।",
        features: [
          "Free की हर चीज़",
          "सोर्सिंग, डिज़ाइन और कॉपी के सीनियर विशेषज्ञ",
          "Amazon, TikTok और YouTube का अतिरिक्त डेटा",
          "शेड्यूल्ड ऑटोमेशन और टीम सीटें",
        ],
        unlock: "ऐसे एजेंट खोलता है जो शेड्यूल पर काम करते रहते हैं, जब आप सो रहे होते हैं।",
        cta: "Pro अनलॉक करें",
        highlight: true,
      },
      {
        name: "Enterprise",
        price: "कस्टम",
        priceNote: "हमारी टीम के साथ तय",
        tagline: "उन टीमों के लिए जो एजेंट को अपने सिस्टम और नियमों से जोड़ना चाहती हैं।",
        features: [
          "Pro की हर चीज़",
          "प्राथमिकता सहायता",
        ...
        unlock: "Accio टीम के साथ गाइडेड सेटअप शामिल है।",
        cta: "पहले आज़माएं",
      },
    ],
  },
...
const fr: Dict = {
  ...
  pricing: {
    eyebrow: "Tarifs",
    heading: "Commencez gratuitement. Payez seulement quand l'agent fait le gros du travail.",
    subheading:
      "Sans carte ni compte à rebours d'essai. Confiez-lui une vraie tâche ce soir et voyez ce que change une équipe d'IA complète.",
    perksTitle: "Ce qui est inclus",
    note: "Les prix et le coût des crédits sont fixés par Accio et peuvent évoluer. Consultez l'application pour les détails à jour.",
    stepsTitle: "Vos 10 premières minutes",
    steps: [
      "Installez et connectez-vous. Aucune carte demandée.",
      "Décrivez une vraie tâche avec des mots simples.",
      "Regardez l'agent ouvrir des sites, comparer des fournisseurs et vous faire un rapport.",
    ],
    plans: [
      {
        name: "Free",
        price: "$0",
        priceNote: "sans carte, sans limite de durée",
        tagline:
          "Un agent IA complet, pas une démo bridée. De quoi lancer un vrai projet dès ce soir.",
        features: [
          "Agent IA disponible 24/7",
          "Plus de 50 intégrations en un clic",
          "Automatisation du navigateur qui clique et remplit les formulaires pour vous",
          "Études de marché sur de vraies données commerciales",
        ],
        unlock: "À tester d'abord : demandez-lui 5 fournisseurs vérifiés pour votre produit.",
        cta: "Commencer gratuitement",
      },
      {
        name: "Pro",
        price: "À l'usage",
        priceNote: "crédits seulement pour les tâches lourdes",
        badge: "Notre choix",
        tagline:
          "Les vendeurs l'activent une fois l'agent gratuit adopté. Les spécialistes prennent en charge des missions entières.",
        features: [
          "Tout le plan Free",
          "Spécialistes seniors en sourcing, design et rédaction",
          "Données en plus d'Amazon, TikTok et YouTube",
          "Automatisations planifiées et places d'équipe",
        ],
        unlock:
          "Débloque des agents qui continuent de travailler selon un planning pendant que vous dormez.",
        cta: "Débloquer Pro",
        highlight: true,
      },
      {
        name: "Enterprise",
        price: "Sur mesure",
        priceNote: "défini avec notre équipe",
        tagline:
          "Pour les équipes qui veulent intégrer l'agent à leurs propres systèmes et règles.",
        features: [
          "Tout le plan Pro",
          "Support prioritaire",
        ...
        unlock: "Inclut une configuration accompagnée par l'équipe Accio.",
        cta: "L'essayer d'abord",
      },
    ],
  },
  compareChat: {
...
const ar: Dict = {
  ...
  pricing: {
    eyebrow: "الأسعار",
    heading: "ابدأ مجاناً. وادفع فقط حين يتولّى الوكيل العمل الثقيل.",
    subheading:
      "بلا بطاقة ولا عدّاد تجربة. أعطه مهمة حقيقية الليلة واكتشف بنفسك كيف يبدو العمل مع فريق ذكاء اصطناعي كامل.",
    perksTitle: "ما الذي تحصل عليه",
    note: "الأسعار وتكلفة الأرصدة تحدّدها Accio وقد تتغيّر. راجع التطبيق لمعرفة التفاصيل الحالية.",
    stepsTitle: "دقائقك العشر الأولى",
    steps: [
      "ثبّت التطبيق وسجّل الدخول. لا أحد يطلب بطاقة.",
      "صِف مهمة حقيقية واحدة بكلمات بسيطة.",
      "شاهد الوكيل يفتح المواقع ويقارن المورّدين ثم يعود إليك بالنتيجة.",
    ],
    plans: [
      {
        name: "مجانية",
        price: "$0",
        priceNote: "بلا بطاقة ولا مهلة",
        tagline: "وكيل ذكاء اصطناعي كامل، لا نسخة تجريبية منقوصة. يكفي لإطلاق مشروع حقيقي الليلة.",
        features: [
          "وكيل ذكاء اصطناعي يعمل على مدار الساعة",
          "أكثر من 50 تكاملاً بنقرة واحدة",
          "أتمتة المتصفّح تنقر وتملأ النماذج عنك",
          "أبحاث سوق على بيانات تجارة حقيقية",
        ],
        unlock: "جرّب أولاً: اطلب منه 5 مورّدين موثّقين لمنتجك.",
        cta: "ابدأ مجاناً الآن",
      },
      {
        name: "احترافية",
        price: "الدفع لكل مهمة",
        priceNote: "أرصدة للمهام الثقيلة فقط",
        badge: "اختيارنا",
        tagline:
          "يفعّله البائعون بعدما يثبت الوكيل المجاني جدارته. الخبراء يتولّون مهام كاملة عنك.",
        features: [
          "كل ما في الباقة المجانية",
          "خبراء كبار في التوريد والتصميم والكتابة",
          "بيانات إضافية من Amazon وTikTok وYouTube",
          "أتمتة مجدولة ومقاعد للفريق",
        ],
        unlock: "يفتح لك وكلاء يواصلون العمل وفق جدول بينما تنام.",
        cta: "افعّل الباقة الاحترافية",
        highlight: true,
      },
      {
        name: "للمؤسسات",
        price: "مخصّص",
        priceNote: "نحدّده مع فريقنا",
        tagline: "للفرق التي تريد ربط الوكيل بأنظمتها وقواعدها الخاصة.",
        features: ["كل ما في الباقة الاحترافية", "دعم ذو أولوية", "أمان وتحكّم متقدّمان", "إعداد شخصي مرافق"],
        unlock: "يشمل إعداداً موجّهاً مع فريق Accio.",
        cta: "جرّبه أولاً",
      },
    ],
  },
