...
const IMG_ALT: Record<TtLang, string> = {
  ...
  ar: "اتجاه منتج يرتفع كموجة مع ساعة إيقاف للسرعة",
};
        ...
        <section className="mt-12">
          ...
          <div className="mt-6 space-y-4">
            {ttFlow.map((s, i) => (
              ...
              >
                <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-muted text-lg font-bold text-[#34d399]">
                  {i + 1}
                </div>
                <div>
