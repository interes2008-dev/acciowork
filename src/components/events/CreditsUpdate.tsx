...
const AR_CREDITS: Dict = {
  badge: "تحديث المنتج",
  title: "الباقة نفسها.",
  titleAccent: "وإنجاز أكثر بنحو 50%.",
  lead: ["«نفدت أرصدتك.» وما زلنا قبل منتصف الشهر.", "فأزحنا تلك الرسالة إلى وقت أبعد في التقويم."],
  headline: "ظننّا ذلك أيضاً.",
  sub: "فجعلنا كل رصيد يمتدّ أبعد. ولّد الصور. ابنِ المواقع. تفاوض مع الموردين. المهام التي كانت تلتهم أرصدة كثيرة صارت أرخص بكثير.",
  bullets: [
    {
      icon: "🖼️",
      title: "توليد الصور",
      desc: "صور المنتجات والإعلانات بجزء بسيط من تكلفة الرصيد السابقة.",
    },
    {
      icon: "🌐",
      title: "بناء المواقع",
      desc: "صفحات هبوط ومتاجر تُولَّد من البداية للنهاية بلا استنزاف باقتك.",
    },
    {
      icon: "🤝",
      title: "التفاوض مع الموردين",
      desc: "محادثات الوكيل الطويلة تكلّف الآن أرصدة أقل بكثير لكل مهمة.",
    },
    {
      icon: "⚡",
      title: "النموذج التلقائي",
      desc: "اختر النموذج التلقائي ويختار Accio Work أرخص محرّك لكل مهمة.",
    },
  ],
  beforeLabel: "قبل",
  afterLabel: "الآن",
  beforeNote: "20 / 20 رصيداً، استُهلكت 100% بحلول منتصف الشهر",
  afterNote: "الباقة نفسها، ومهام أكثر بنحو 50%",
  cta: "حدّث وجرّب مجاناً",
  note: "حدّث إلى أحدث إصدار، اختر النموذج التلقائي وتحقّق بنفسك.",
};
