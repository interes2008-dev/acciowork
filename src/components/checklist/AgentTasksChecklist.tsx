        ...
        <div className="mx-auto flex max-w-3xl items-center justify-between px-5 py-4">
          ...
          <div className="flex min-w-0 items-center gap-2 sm:gap-3">
            ...
            <a
              ...
              className="max-w-[34vw] truncate whitespace-nowrap rounded-full bg-[#34d399] px-3 py-2 text-[13px] font-semibold text-[#04120d] transition hover:brightness-110 sm:max-w-none sm:px-4 sm:text-sm"
            >
              {c.cta}
            </a>
          </div>
